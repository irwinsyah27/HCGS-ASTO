    ...
    if($ldap->g_User() && $ldap->g_Pass()){
        if($ldap->LdapConn()){
            if($ldap->LdapBind()){
				...
				echo ("
<body>  
<script language=JavaScript>close()
window.open ('Utama.php', '','location=yes, statusbar=yes,width=3000,height=1000');</SCRIPT></BODY>");
				}
    ...
    <tr>
        <td>
            ...
            <table style="width:350px; height:150px;" cellspacing="0" cellpadding="0" align="center" valign="middle">
                ...
                <tr><td><input type="submit" name="validate" value="Go!" /></td></tr>
            </table>
            </form>
        </td>
    </tr>
