<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="lstDinas.aspx.vb" Inherits="lstDinas" title="List Surat Dinas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT tblSutu.NomorST, tblKaryawan.Nama, tblSutu.Nrp, tblKaryawan.Jabatan, tblKaryawan.Departemen, tblSutu.Tujuan, tblSutu.Awal, tblSutu.Akhir, tblSutu.Keperluan FROM tblKaryawan INNER JOIN tblSutu ON tblKaryawan.Nrp = tblSutu.Nrp Where Keperluan Like '%DINAS%'">
    </asp:SqlDataSource>
</asp:Content>
