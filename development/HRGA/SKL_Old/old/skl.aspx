<%@ Page Language="VB" debug="true" AutoEventWireup="false" CodeFile="skl.aspx.vb" Inherits="skl" %>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; position: static">
            ...
            <tr>
                ...
                <td style="border-right: black 2px solid; width: 59%; border-bottom: maroon 1px solid;
                    background-color: floralwhite">
            ...
            <tr>
                <td colspan="3" style="border-right: black 2px solid; border-top: silver 1px dotted;
                    ...
                    <asp:Button ID="btnadd1" runat="server" Text="....Select Karyawan..." />
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 100%" width="100%">
                        ...
                        <tr>
                            <td style="width: 30%; height: 96px">
                                <asp:ListBox ID="listnrp" runat="server" Height="110px" Width="100%" AutoPostBack="True"></asp:ListBox></td>
                            <td style="width: 70%; height: 96px">
                                <asp:ListBox ID="listnama" runat="server" Height="110px" Width="100%" Enabled="False"></asp:ListBox></td>
                        </tr>
                    </table>
                    &nbsp; &nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td align="left" style="border-right: black 2px solid; width: 59%; border-bottom: maroon 1px solid;
                    background-color: floralwhite">
            ...
            <tr>
                <td align="center" colspan="3" style="border-left-width: 2px; border-left-color: black; border-bottom-width: 2px; border-bottom-color: black; border-right-width: 2px; border-right-color: black;">
