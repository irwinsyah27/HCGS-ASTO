<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LemburAccAdmin.aspx.vb" Inherits="HRGA_Report_LemburAccAdmin" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" BorderStyle="Solid" BorderWidth="1px"
            ...
            <ServerReport ReportPath="/hrga/Lembur_Per_Periode_Per_Nrp_MultiSelect" />
        </rsweb:ReportViewer>
