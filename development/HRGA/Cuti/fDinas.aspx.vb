...
Partial Class _fDinas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If InStr(1, Session("jabatan").ToString, "ICT OFFICER") = 0 And InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") = 0 And InStr(1, Session("jabatan").ToString, "PERSONNEL OFFICER") = 0 And InStr(1, Session("jabatan").ToString, "PERSONNEL ADMIN") = 0 And InStr(1, Session("ndPosisi").ToString, "PERSONNEL SITE OFFICER") = 0 And InStr(1, Session("ndPosisi").ToString, "PERSONNEL OFFICER") = 0 And InStr(1, Session("ndPosisi").ToString, "PERSONNEL ADMIN") = 0 And InStr(1, Session("ndPosisi").ToString, "KORLAP MBAP") = 0 Then
