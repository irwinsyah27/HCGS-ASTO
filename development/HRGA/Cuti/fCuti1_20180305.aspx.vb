...
Partial Class _fCuti1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dr.Read = True Then
            ...
            '--------
			If Session("Admin").ToString <> "Admin" AND Session("Jabatan").ToString <> "KORLAP" AND Session("Jabatan").ToString <> "KORLAP MBAP" AND Session("Jabatan").ToString <> "KORLAP GNI" AND Session("Jabatan").ToString <> "KORLAP SIGAP" Then
