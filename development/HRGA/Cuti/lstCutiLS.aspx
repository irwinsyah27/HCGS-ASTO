...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="width: 82%; text-align: center">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="14pt" Text="Karyawan Cuti LS"></asp:Label><br />
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataDept"
    ...
    </asp:DropDownList><asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Status :"></asp:Label>
        ...
        SelectCommand="SELECT DISTINCT [Departemen] FROM [tblKaryawan] UNION SELECT '' AS  [Departemen] UNION SELECT 'ALL DEPT' AS [Departemen]">
                ...
                <asp:SqlDataSource ID="SqlCompany" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT DISTINCT [company] FROM [tblKaryawan] Where [company] ='&quot; & Session(&quot;Company&quot;).ToString & &quot;' UNION SELECT '' AS  [company]">
    </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
