...
<body>
    ...
    <div>
        <table border="0" cellpadding="5" cellspacing="0" style="width: 100%; height: 100%; border-right: #3366cc 1px solid; border-top: #3366cc 1px solid; border-left: #3366cc 1px solid; border-bottom: #3366cc 1px solid;" id="TABLE1" language="javascript" onclick="return TABLE1_onclick()">
            <tr>
            ...
            <tr>
                <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; width: 100%;" valign="top">
		            ...
		            href="javascript:;"><IMG src="Images/GoLtrHS.png" border="0" id="IMG3" runat="server" align="absMiddle" height="16" width="16"></A>
                                        ...
                                        <td align="right">
                                            <asp:Label ID="Label11" runat="server" Text="Periode Dinas" Width="89px"></asp:Label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;" rowspan="4" valign="top">
                                            <asp:Label ID="lblAlamatdiSite" runat="server" Font-Size="10pt" Width="167px"></asp:Label></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" colspan="5" style="height: 19px" valign="top">
                                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                                DataSourceID="SqlDataSource1" Width="100%" Visible="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="9pt" ForeColor="Black" GridLines="Horizontal">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Nama" SortExpression="Nama">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Nama") %>' Width="112px"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tanggal" SortExpression="Tanggal">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Tanggal") %>' Width="112px"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Dari_Ke" SortExpression="Dari_Ke">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Dari_Ke") %>' Width="78px"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
