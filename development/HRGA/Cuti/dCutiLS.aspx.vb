    ...
    Sub CariSC()
        ...
        If dr.Item("PersetujuanAtasan").ToString <> "" Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                Me.Panel2.Enabled = False
            Else
                If InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP DAB") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP GNI") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP SIGAP") > 0 Then
                    Me.Panel2.Enabled = True
                    Me.btnPrint.Enabled = True
                    'ElseIf InStr(1, Session("ndPosisi").ToString, "SECT. HEAD") > 0 Then
                ElseIf InStr(1, Session("ndPosisi").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("ndPosisi").ToString, "PAYROLL OFFICER") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP DAB") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP GNI") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP SIGAP") > 0 Then
