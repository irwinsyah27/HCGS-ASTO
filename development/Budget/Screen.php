<HTML>
  <HEAD>
	<title>Reporting Budget System</title>
	...
	<script src="../Tools/ui/jquery.ui.progressbar.js"></script>
	...
	<!--
		...
		.small { font: 8pt Verdana, Arial, Helvetica; width: 400px; text-align: center }
		b { font-weight: bold }	
		a { text-decoration : none }
	// -->
	</style>
	<style>
	.ui-progressbar-value { background-image: url(images/loading.gif); }
	</style>
	<script>
	$(function() {
        ...
        if (value < 100) {
            $("#progressbar").progressbar("value", value + 12.5);               
		}
		}
	</script>
 ...
 *
 */
		fadeText("fadeMe01", "<span class=content><b>Optimize WoRKz</a></b> Integreted</span><div class=small>proudly presents</div>", "000000", "CCCCCC", 1000, 2);
		setTimeout('fadeText("fadeMe01", "<span class=content><b>Optimize WoRKz</b> Integreted</span><div class=small>proudly presents</div>", "CCCCCC", "000000", 10, 4)',800);
		setTimeout('fadeText("fadeMe01", "<div class=small>A</div><span class=content><b>Optimize WoRKz</b> Production</span>", "000000", "CCCCFF", 10, 2)',1200);
		setTimeout('fadeText("fadeMe01", "<div class=small>A</div><span class=content><b>Optimize WoRKz</a></b> Production</span>", "CCCCFF", "000000", 10, 4)',2000);
		setTimeout('moveLayer("fadeMe01", midY-100, midX-200)',2400);
		setTimeout('moveLayer("fadeMe02", midY-60, midX-200)',2400);
		setTimeout('fadeText("fadeMe01", "<span class=content><b>Reporting Budget System</b></span>", "000000", "CCCCFF", 10, 4)',2600);
		setTimeout('fadeText("fadeMe02", "<span class=content>VeRSioN 1.2</span>", "000000", "9999FF", 10, 4)',3200);
		setTimeout('fadeText("fadeMe01", "<span class=content><b>Reporting Budget System</b></span>", "000000", "FF0000", 10, 4)',3600);
		setTimeout('fadeText("fadeMe02", "<span class=small>&copy; Copyright IT rantau &nbsp;. . . VeRSioN 1.2</div>", "000000", "CCCCCC", 10, 4)',5200);
...
function timeMsg()
{
var t=setTimeout("alertMsg()",8000);
}
function alertMsg()
{
window.open('http://10.13.17.55/reportserver?%2fR-bu-S%2f%5bR-Bu-S%5d&rs:Command=Render','_blank');
}
</script>
  </HEAD>

  <BODY BGCOLOR="#000000" text="#CCCCCC" link="#FFFFFF" vlink="#FFFFFF" onLoad="layout();timeMsg()">
