...
$NmSec=$Sec;
if (($NmSec==$_SESSION[NamaSec]) or (($_SESSION[User]=='6100077') or ($_SESSION[User]=='TA11001') or ($_SESSION[User]=='KB05002') or ($_SESSION[User]=='KC07103') or ($_SESSION[User]=='6195011'))) {
