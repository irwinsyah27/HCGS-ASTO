...
$NmSec=$d1[NamaSec];
if (($NmSec==$_SESSION[NamaSec]) or (($_SESSION[User]=='6100077') or ($_SESSION[User]=='KB09032') or ($_SESSION[User]=='KC05046') or ($_SESSION[User]=='6195011') or ($_SESSION[User]=='KC07103') or ($NmSec=='PIC'))) {
