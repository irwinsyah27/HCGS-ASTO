...
if($mKepada!=$_SESSION[NamaSec]){
	...
	require("../../../Tools/config.php");
	//set sudah dibaca = Y kalau sudah dibaca
	$insert = mysql_query("INSERT INTO tabel_pesan VALUES(null,'$DateTimeSkrg''$d1[jam]','PKH','HeadHRPGA','$PKH','N')"); }
  ...
  Instruksi_kerja='$mInstruksi', Laporan_Pelaksanaan='$mLaporan', Status='$mStatus', Lampiran='$namaFile', TglUpdate='$DateTimeSkrg''$d1[jam]',
