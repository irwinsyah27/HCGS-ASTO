...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#99CC99" align="center">
  <tr>
    ...
    <td width="81%" bgcolor="#009933" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">FORUM</font></strong></div></td>
    ...
    <td><table width="100%" align="center">
      <tr>
		...
		if ($get_pages>$entries)  //proses
		{
			...
			?>
                <a href="forum.php?id=<? echo ($pages-1); ?> " style="text-decoration:none"><font size="2" face="verdana" color="#009900"><? echo $pages; ?></font></a>
                <?
					$pages++;
			}
		}else{
		...
		if ($jumlah){
          ...
          <table width="100%" height="89"   border="0" align="center">
			...
			?>
                <tr>
                  <td align="left"><b><a href="forum-view.php?ID_topik=<? echo $ID_topik;?>" style="text-decoration:none "> 
		...
		?>
          ...
          <p align="center"><a href="forum-new.php" style="text-decoration:none" title="Membuat Topik Baru"><img src="./img/forum.png" border="0"></a>Baru</p>
          </td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td bgcolor="#009933" ><div align="center"><strong><font face="verdana" size="1" color="#333333">Jumlah Topik : <? echo $jumlah; ?></font></strong></div></td>
