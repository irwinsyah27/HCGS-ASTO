...
// ----- SQL data PKH
$sel2=mysql_query("select No, bHarian.Judul, bHarian.Gambar, bHarian.Isi, bHarian.Tgl, bHarian.Jenis, bHarian.NRP from bHarian where bHarian.Jenis='$mJenis' order by bHarian.Tgl Desc limit $curRec,$maxRec")
or die ("Salah SQL 1!");
...
<tr>
                <td bgcolor="#666666"><div align="right">
				  ...
				  // get total Record from your table in database
					$tot=mysql_query("select count(*) as tot from bHarian where bHarian.Jenis='$mJenis'")or die ("Salah SQL 2!");	
