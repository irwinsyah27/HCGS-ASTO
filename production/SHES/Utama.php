...
href="Utama">sMs Service Command</a></SMALL></H1>
<UL class=columns>
  <LI><A href="Utama"><IMG 
  src="Images/she.gif" alt="SHE Alert" width="220" height="200" onclick="MM_openBrWindow('Alert/Utama.php','MenuAlert','status=yes,scrollbars=yes,width=1000,height=700')"></A> 

  <DIV class=info>
  <H2 align="center" class="ui-state-active">SHE Alert</H2>
  <P>Informasi & Pelaporan Insiden. . </P></DIV></LI>
  <LI><A href="Utama"><IMG 
  src="Images/CCRInfo.png" alt="" width="220" height="200" onclick="MM_openBrWindow('CCR/Utama.php','MenuAlert','status=yes,scrollbars=yes,width=1200,height=700')"></A> 

  <DIV class=info>
  <H2 align="center" class="ui-state-active">CCR Info</H2>
  <P>Info CCR </P></DIV></LI>
  <LI><A href="Utama"><IMG 
