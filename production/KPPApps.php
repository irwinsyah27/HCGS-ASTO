<?php
	...
	if ($_SESSION['User']) {
		...
		echo ("<meta http-equiv=refresh content=1;url=http://pabbapco401.kppmining.net:83/production/production/SessionOff.php>");
		exit();	
	}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://pabbapco401.kppmining.net:83/production/tools/layout-default-latest.css" />
	<link rel="stylesheet" type="text/css" href="http://pabbapco401.kppmining.net:83/production/tools/themes/south-street/jquery.ui.all.css" />
	<!-- CUSTOMIZE/OVERRIDE THE DEFAULT CSS -->
	<link href="http://pabbapco401.kppmining.net:83/production/Tools/css/style.css" rel="stylesheet" type="text/css" media="screen" />
	<link media="screen" href="http://pabbapco401.kppmining.net:83/production/Tools/jquery.msg.css" rel="stylesheet" type="text/css">
	<link media="screen" href="http://pabbapco401.kppmining.net:83/production/Chatting/css/chat.css" rel="stylesheet" type="text/css">
	<link media="screen" href="http://pabbapco401.kppmining.net:83/production/Chatting/css/screen_ie.css" rel="stylesheet" type="text/css">
	<style type="text/css">
	...
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/tools/jquery-latest.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/tools/jquery-ui-latest.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/tools/jquery.layout-latest.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/tools/jquery.layout.resizePaneAccordions-1.0.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/Tools/jquery.center.min.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/Tools/jquery.msg.min.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/Tools/chat.js"></script>
...
<div class="ui-layout-north ui-widget-content" style="display: none;">
			<div class="item">
                ...
                <div class="item_content">
                    <h2>LogOff</h2>
                    <pM>
                        <a href="http://pabbapco401.kppmining.net:83/production/SessionOff.php" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Logoff</a>
					</pM>
				</div>
            </div>
			<div class="item">
                ...
                <div class="item_content">
                    ...
                    <pM>
                        ...
                        <a href="http://pabbapco401.kppmining.net:83/production/Tools/extlpn.pdf" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Go</a>
					</pM>
				</div>
            </div>
			<div class="item">
                ...
                <div class="item_content">
                    ...
                    <pM>
                        <a href="//pabbapco401.kppmining.net:83/MeetingOL/Utama" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Meeting</a>
                        <a href="http://pabbapco401.kppmining.net:83/production/TaskFlow/Utama.php" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">TaskFlow</a>
                        <a href="http://pabbapco401.kppmining.net:83/production/SHES/Utama.php" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">SMS</a>
			...
			<div class="item">
                ...
                <div class="item_content">
                    ...
                    <pM>
					    <a href="//pabbapco401.kppmining.net/HRGA" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Hrga-OL</a>
                        <a href="http://pabbapco401.kppmining.net:83/production/EWACS/Index.htm" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Ewacs</a>
                        <a href="http://pabbapco401.kppmining.net:83/production/Budget/Screen.php" target="kanan" onclick="$.msg({fadeIn : 500, fadeOut : 500, timeOut : 5000});">R-bu-S</a>
                        <a href="http://pabbapco401.kppmining.net:83/production/Sigap/Utama.php" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Security</a>
                    </pM>
                </div>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <div class="item_content">
                    <h2>HOME</h2>
                    <pM>
                        <a href="//pabbapco401.kppmining.net:83/Berita/Utama.php?mJenis=All" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">News</a>
...
<div class="ui-layout-center" style="display: none;"> 
	...
	<!-- <div class="ui-layout-content ui-widget-content"> -->
		<iframe src="<?php if($Link!=''){echo $Link;} else { echo "http://pabbapco401.kppmining.net:83/production/Berita/NilaiInti.php";} ?>" id="kanan" name="kanan" width="100%" height="100%" align="Center" hspace="0" vspace="0" scrollbar="yes"> </iframe>
	<!-- </div> -->
</div>
...
<div class="ui-layout-east" style="display: none;">
	...
	<!-- script untuk Menu -->
    <script type="text/javascript" src="http://pabbapco401.kppmining.net:83/production/tools/jquery-animate-css-rotate-scale.js"></script>
	<script>
            $('.item').hover(
                function(){
                    var $this = $(this);
