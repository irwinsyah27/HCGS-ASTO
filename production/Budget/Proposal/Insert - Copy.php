...
<table width="100%" border="0" align="center">
  <tr>
    <td><div align="center" class="style52">
      <p>
        PROPOSAL BUDGET DEPT.  <?php echo $mmDept ;
...
$TIBS = number_format($rowIBS[IBS],0,",","."); 
  ...
  <tr>
    <td><div align="center" class="style52 style54">Periode <?php echo $pick_date ; ?> s/d <?php echo $pick_date2 ; ?> </div></td>
  </tr>
  <tr>
        ...
        <tr>
          <td bgcolor="#CCFFFF"><table width="100%" border="0">
            <tr>
			  ...
			  <?php echo $rowIBS[IBS]-$rowIBS[Nominal]/$rowIBS[IBS]*100 ; 
			  ?></td>
            </tr>
          </table></td>
        </tr>
...
<iframe src="http://RANTAPPU401/reportserver?%2fBudgetSystem%2f_Proposal_Insert&rs:Command=Render" id="kanan" name="kanan" width="97.5%" height="800" align="Center" hspace="0" vspace="5" scrollbar="yes">
</iframe>
</body>
</html>
