...
<tr> 
	...
	<td width="95%" bgcolor="#009933" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">View Forum</font></strong></div></td>
			...
			<td>
				<center>
				  <p><a href="index.php?page=10&ID_topik=<? echo $ID_topik; ?>&topik=<? echo $topik;?>" style="text-decoration:none ">
				      </a><a href="forum.php" title="Kembali"><img src="./img/back.png" alt="kembali" border="0"></a><a href="forum-reply.php?ID_topik=<? echo $ID_topik; ?>&topik=<? echo $topik;?>" style="text-decoration:none "><img src="./img/reply.gif" border="0"></a></p>
