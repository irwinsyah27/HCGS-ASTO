...
$sel1=mysql_query("Select Departemen.DeptHead from Departemen where Departemen.NoDept='6'")or die ("Terdapat kesalahan pada perintah SQL!");
}
                      ...
                      <tr>
                        ...
                        <td width="14%"><div align="right">
                            <select name="Jmenu" onChange="MM_jumpMenu(this,'Report','width=1000,height=590,scrollbars=yes')">
                              <option value="#"> </option>
                              <option value="../../ReportServer/PKH/PLANT/Open_PerPerioderpt.php">PKH_Open</option>
                              <option value="../../ReportServer/PKH/PLANT/Close_PerPerioderpt.php">PKH_CloseOff</option>
                              <option value="../../ReportServer/PKH/PLANT/Diagram_Secctb.php">Chart_StatusLaporan</option>
                            </select>
                        </div></td>
                      </tr>
                  </table></td>
                  ...
                  <td><table width="100%" border="0" bgcolor="#333333">
                    <tr>
                      ...
                      <select name="mKepada" id="mKepada" lang="" onChange="this.form.submit()">
                        ...
                        <option value="Planner" <?php if (!(strcmp("Planner", $mKepada))) {echo "selected=\"selected\"";} ?>>Planner</option>
                        <option value="STD" <?php if (!(strcmp("STD", $mKepada))) {echo "selected=\"selected\"";} ?>>STD</option>
                        <option value="SSE" <?php if (!(strcmp("SSE", $mKepada))) {echo "selected=\"selected\"";} ?>>SSE</option>
                        <option value="Crusher" <?php if (!(strcmp("Crusher", $mKepada))) {echo "selected=\"selected\"";} ?>>Crusher</option>
                        <option value="BRE-EBL" <?php if (!(strcmp("BRE-EBL", $mKepada))) {echo "selected=\"selected\"";} ?>>BRE-EBL</option>
                        <option value="CABE-TM-PSD" <?php if (!(strcmp("CABE-TM-PSD", $mKepada))) {echo "selected=\"selected\"";} ?>>CABE-TM-PSD</option>
                      </select>
                      </span></span></td>
                      <td width="22%"><label>
                        <div align="right">
