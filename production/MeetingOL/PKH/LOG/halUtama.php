...
$sel1=mysql_query("Select Departemen.DeptHead from Departemen where Departemen.NoDept='4'")or die ("Terdapat kesalahan pada perintah SQL!");
}
                      ...
                      <tr>
                        ...
                        <td width="14%"><div align="right">
                            <select name="Jmenu" onChange="MM_jumpMenu(this,'Report','width=1000,height=590,scrollbars=yes')">
                              <option value="#"> </option>
                              <option value="../../ReportServer/PKH/LOG/Open_PerPerioderpt.php">PKH_Open</option>
                              <option value="../../ReportServer/PKH/LOG/Close_PerPerioderpt.php">PKH_CloseOff</option>
                              <option value="../../ReportServer/PKH/LOG/Diagram_Secctb.php">Chart_StatusLaporan</option>
                            </select>
                        </div></td>
                      </tr>
                  </table></td>
                  ...
                  <td><table width="100%" border="0" bgcolor="#333333">
                    <tr>
                      ...
                      <select name="mKepada" id="mKepada" lang="" onChange="this.form.submit()">
                        ...
                        <option value="FAO" <?php if (!(strcmp("FAO", $mKepada))) {echo "selected=\"selected\"";} ?>>FAO</option>
                        <option value="Purchasing" <?php if (!(strcmp("Purchasing", $mKepada))) {echo "selected=\"selected\"";} ?>>Purchasing</option>
                        <option value="Warehouse" <?php if (!(strcmp("Warehouse", $mKepada))) {echo "selected=\"selected\"";} ?>>Warehouse</option>
                        <option value="Inventory" <?php if (!(strcmp("Inventory", $mKepada))) {echo "selected=\"selected\"";} ?>>Inventory</option>
                      </select>
                      </span></span></td>
                      <td width="22%"><label>
                        <div align="right">
