...
$sel1=mysql_query("Select Departemen.DeptHead from Departemen where Departemen.NoDept='5'")or die ("Terdapat kesalahan pada perintah SQL!");
}
                      ...
                      <tr>
                        ...
                        <td width="14%"><div align="right">
                            <select name="Jmenu" onChange="MM_jumpMenu(this,'Report','width=1000,height=590,scrollbars=yes')">
                              <option value="#"> </option>
                              <option value="../../ReportServer/PKH/ENG/Open_PerPerioderpt.php">PKH_Open</option>
                              <option value="../../ReportServer/PKH/ENG/Close_PerPerioderpt.php">PKH_CloseOff</option>
                              <option value="../../ReportServer/PKH/ENG/Diagram_Secctb.php">Chart_StatusLaporan</option>
                            </select>
                        </div></td>
                      </tr>
                  </table></td>
                  ...
                  <td><table width="100%" border="0" bgcolor="#333333">
                    <tr>
                      ...
                      <select name="mKepada" id="mKepada" lang="" onChange="this.form.submit()">
                        <option value="" <?php if (!(strcmp("", $mKepada))) {echo "selected=\"selected\"";} ?>></option><option value="Moco" <?php if (!(strcmp("Moco", $mKepada))) {echo "selected=\"selected\"";} ?>>Moco</option>
                        <option value="MinePlan" <?php if (!(strcmp("MinePlan", $mKepada))) {echo "selected=\"selected\"";} ?>>MinePlan</option>
                        <option value="Quality" <?php if (!(strcmp("Quality", $mKepada))) {echo "selected=\"selected\"";} ?>>Quality</option>
                        <option value="Survey" <?php if (!(strcmp("Survey", $mKepada))) {echo "selected=\"selected\"";} ?>>Survey</option>
                      </select>
                      </span></span></td>
                      <td width="22%"><label>
                        <div align="right">
