...
$NmSec=$Sec;
if (($NmSec==$_SESSION[NamaSec]) or (($_SESSION[User]=='6100077') or ($_SESSION[User]=='6197112') or ($_SESSION[User]=='KB08004') or ($_SESSION[User]=='KC07103') or ($_SESSION[User]=='6195011'))) {
