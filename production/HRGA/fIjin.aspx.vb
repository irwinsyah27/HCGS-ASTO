...
Partial Class HRGA_fIjin
    ...
    Sub DataKaryawan()
        ...
        With cmd
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "Select Nrp,Nama,Departemen,StatusKawin,StatusKeluarga,SisaCutiPeriode1,SisaCutiBesar,SisaCutiPeriode2,SisaCuti = SisaCutiPeriode1 + SisaCutiPeriode2 ,StatusBawaKeluarga = Case StatusBawaKeluarga When 1 Then 'YA' Else 'TIDAK' End  From tblKaryawan Where Nrp = @Nrp"
        ...
        If dr.Read = True Then
            ...
            Me.lblSisaCutiBesar.Text = dr.Item("SisaCutiBesar").ToString & " hari"
