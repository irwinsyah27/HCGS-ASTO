...
Partial Class HRGA_SKL_SKaEl_Ha
    ...
    Protected Sub calawallbr_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles calawallbr.SelectionChanged
        If Me.calawallbr.SelectedDate.Date >= Date.Today.AddDays(-3) Then
    ...
    Protected Sub btnsend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsend.Click
        ...
        If DeptKar = "PLANT" Then
            ...
            With cmd2
                .Connection = con
                .CommandType = CommandType.Text
                .CommandText = "Insert Into tbl_skl1 (NoSKL,NRPrequestor,TglCreated,uraianLembur,aprovedept,nrpaproved,tglaproved,catatan,aprovehr,nrphr,tglhraproved,catatanhr,skl,proses,status) Values(@NoSKL,@NrpUser,getdate(),@uraianlembur,'1','0187323',getdate(),'Approved by System','1',@NrpUser,getdate(),'Approved by PM',@skl,'1','complete')"
