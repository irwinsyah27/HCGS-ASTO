...
<body>
    ...
    <div>
        <table border="1" cellpadding="5" cellspacing="2" style="width: 100%; height: 100%; border-right: #0066cc 1px solid; border-top: #0066cc 1px solid; border-left: #0066cc 1px solid; border-bottom: #0066cc 1px solid;" id="TABLE1" language="javascript" onclick="return TABLE1_onclick()">
            <tr>
                <td valign="top" align="center" style="width: 97%">
            ...
            <tr>
                <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; width: 97%;" valign="top">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 47%; height: 24px">
                                            <asp:TextBox ID="txtAwal" runat="server" AutoPostBack="True" Width="136px"></asp:TextBox>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                            ...
                            <tr>
                                <td style="text-align: center" valign="top" width="35%">
                                    ...
                                    <asp:Label ID="lblJabatan1" runat="server" Font-Bold="False" Font-Size="10pt" Width="80%"></asp:Label></td>
                                <td style="text-align: center" valign="top" width="35%">
                                    <br />
                                    <br />
                                    <br />
                                    <br />
                                    <br />
                                    <asp:Label ID="lblHrga" runat="server" Font-Bold="True" Font-Size="10pt" Font-Underline="True" Width="80%"></asp:Label><br />
                                    <asp:Label ID="lblJabatan2" runat="server" Font-Bold="False" Font-Size="10pt" Width="80%"></asp:Label></td>
                                <td style="text-align: center" valign="top" width="30%">
                                    <asp:Label ID="Label48" runat="server" Text="Personnel Admin : " Width="80%"></asp:Label><br />
                                    <br />
                                    <br />
                                    <br />
                                    <br />
                                    <asp:Label ID="lblPersonnelAdmin" runat="server" Font-Bold="True" Font-Size="10pt" Font-Underline="True" Width="80%"></asp:Label><br />
                                    <asp:Label ID="lblJabatan3" runat="server" Font-Bold="False" Font-Size="10pt" Width="80%"></asp:Label></td>
                            </tr>
                        </table>
                    </asp:Panel>
                    &nbsp;
