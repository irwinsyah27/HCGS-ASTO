<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditKaryawanLS.aspx.vb" Inherits="HRGA_EditKaryawan" %>
    ...
    <fieldset style="width: 334px"><legend>Edit Karyawan </legend>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
            ...
            <SelectParameters>
                ...
                <asp:CookieParameter CookieName="Company" Name="Company" />
            </SelectParameters>
            <InsertParameters>
                <asp:Parameter Name="Nrp" Type="String" />
                <asp:Parameter Name="Nama" Type="String" />
        ...
        </asp:SqlDataSource><asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
            DeleteCommand="DELETE FROM [tblKaryawan] WHERE [Nrp] = @Nrp"
            SelectCommand="SELECT Company FROM [tblKaryawan] WHERE (Company = @Company )">
            <SelectParameters>
                <asp:CookieParameter CookieName="Company" Name="Company" />
            </SelectParameters>
            <DeleteParameters>
