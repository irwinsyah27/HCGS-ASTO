<%@ Page Language="VB" Debug="true" AutoEventWireup="false" CodeFile="trainsite.aspx.vb" Inherits="trainsite" %>
...
<body>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #ffc080 1px solid;
            border-top: #ffc080 1px solid; border-left: #ffc080 1px solid; border-bottom: #ffc080 1px solid" width="100%">
            <tr>
                <td colspan="3" style="border-left-width: 1px; border-left-color: #ffe0c0; border-bottom-width: 1px;
                    border-bottom-color: #ffe0c0; height: 495px; border-right-width: 1px; border-right-color: #ffe0c0; width: 100%;"
                    valign="top">
                    <table border="0" cellpadding="3" cellspacing="3" style="width: 100%; height: 100%">
                        <tr>
                            <td style="border-right: #99ff66 1px solid; border-top: #99ff66 1px solid; border-left: #99ff66 1px solid;
                                width: 100%; border-bottom: #99ff66 1px solid; height: 409px" valign="top">
                                &nbsp;
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; position: static">
                                    ...
                                    <tr>
                                        <td style="border-left: black 2px solid; width: 25%; border-bottom: maroon 1px solid;
                                            ...
                                            <asp:Label ID="lblawalskl" runat="server" Text="Awal Training" Visible="False" Width="100%"></asp:Label></td>
                                        <td align="center" style="width: 5%; border-bottom: maroon 1px solid; background-color: floralwhite">
                                        ...
                                        <td align="left" style="border-right: black 2px solid; width: 70%; border-bottom: maroon 1px solid;
                                            ...
                                            <asp:Button ID="btnawaltraining" runat="server" Text="Awal Training" Visible="False" />
                                            ...
                                            <asp:Label ID="lblawallbr" runat="server" Text="Jam " Visible="False"></asp:Label><asp:DropDownList
                                                ID="ddlawal1" runat="server" Visible="False">
                                    ...
                                    <tr>
                                        <td style="border-left: black 2px solid; width: 25%; border-bottom: maroon 1px solid;
                                            ...
                                            <asp:Label ID="lblakhirSKL" runat="server" Text="Akhir training" Visible="False"
                                        ...
                                        <td align="left" style="border-right: black 2px solid; width: 70%; border-bottom: maroon 1px solid;
                                            ...
                                            <asp:Button ID="btnakhirtrain" runat="server" Text="Akhir Training" Visible="False" />
                                    ...
                                    <tr>
                                        <td style="border-left: black 2px solid; width: 25%; border-bottom: maroon 1px solid;
                                            ...
                                            <asp:Label ID="lblUraianKerja" runat="server" Text="Uraian Training" Visible="False"
                                                Width="100%"></asp:Label></td>
                                    ...
                                    <tr>
                                        <td style="border-left: black 2px solid; width: 25%; border-bottom: maroon 1px solid;
                                            height: 19px; background-color: floralwhite">
                                            <asp:Label ID="lbllokasi" runat="server" Text="Lokasi Training" Visible="False" Width="100%"></asp:Label></td>
                                        <td align="center" style="width: 5%; border-bottom: maroon 1px solid; font-family: FloralWhite;
                                            height: 19px; background-color: floralwhite">
                                        ...
                                        <td align="left" style="border-right: black 2px solid; width: 70%; border-bottom: maroon 1px solid;
                                            font-family: FloralWhite; height: 19px; background-color: floralwhite">
                                            <asp:DropDownList ID="ddllokasi" runat="server" AutoPostBack="True" Visible="False">
                                                <asp:ListItem>-</asp:ListItem>
                                                <asp:ListItem>Tutupan 1</asp:ListItem>
                                                <asp:ListItem>Tutupan 2</asp:ListItem>
                                                <asp:ListItem>Wara</asp:ListItem>
                                                <asp:ListItem>KM64</asp:ListItem>
                                                <asp:ListItem>MegaShop</asp:ListItem>
                                                <asp:ListItem>Pasarpanas</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:Label ID="lbl01" runat="server" ForeColor="Red" Visible="False"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="3" style="border-right: black 2px solid; border-left: black 2px solid;
