...
Partial Class _Default
    ...
    Sub AwalCutiTahunan()
        ...
        If Me.txtAwal.Text <> "" Then
            ...
            temp2 = Format(AwalCTahunan, "dd MMM yyyy")

            If Me.txtTahunan.Text <> "" Then

                For i = 0 To CInt(Me.txtTahunan.Text) + CInt(Me.txtBesar.Text) - 1
                    If temp1.DayOfWeek = 6 Then
                        sabtu_minggu = sabtu_minggu + 2
                        temp1 = Format(temp1.AddDays(3), "dd MMM yyyy")
                    Else
                        temp1 = Format(temp1.AddDays(1), "dd MMM yyyy")
                    End If

                Next

                Me.txtAkhir.Text = Format(AwalCTahunan.AddDays(CInt(Me.txtTahunan.Text) + CInt(Me.txtBesar.Text) + sabtu_minggu - 1), "dd MMMM yyyy")
                'message.Text = i
            Else
                Me.txtAkhir.Text = Format(AwalCTahunan.AddDays(-1), "dd MMMM yyyy")

            End If

            'Me.txtAkhir.Text = FormatDateTime(AwalCTahunan.AddDays(Me.txtTahunan.Text + sabtu_minggu), DateFormat.LongDate)
        End If
    End Sub
    ...
    Sub CariSC()
        ...
        If dr.Read = True Then
            ...
            Me.txtAwal.Text = Format(CDate(dr.Item("Awal").ToString), "dd MMMM yyyy")
            Me.txtAkhir.Text = Format(CDate(dr.Item("Akhir").ToString), "dd MMMM yyyy")
