...
Partial Class Aprovehr
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("Dept") = "" Then
            'MsgBox("iii")
            Session("Q") = "aprovehr.aspx?n=" & Request.QueryString("n").ToString
            'Response.Redirect("loginl.aspx")
            Response.Redirect("login.aspx")
        Else
            Me.lblnamahr1.Text = Session("nama").ToString
    ...
    Protected Sub btnhr1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnhr1.Click
        ...
        With cmd2
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "update tbl_skl set nrphr=@nrphr, tglhraproved=getdate(), catatanhr=@catatanhr where noskl='" & Request.QueryString("n").ToString & "'"
