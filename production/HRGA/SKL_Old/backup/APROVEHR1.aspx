<%@ Page Language="VB" AutoEventWireup="false" CodeFile="aprovehr1.aspx.vb" Inherits="aprovehr" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="left" colspan="3" style="border-right: black 2px solid; border-bottom-width: 1px;
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=10.2.167.102;Initial Catalog=Data_abs1;Persist Security Info=True;User ID=sa;Password=PAMA.456"
                        DeleteCommand="DELETE FROM [Tbl_subSKL] WHERE [ID] = @ID" InsertCommand="INSERT INTO [Tbl_subSKL] ([NoSKL], [Nrp], [AwalLembur], [akhirLembur], [Aprove], [Total]) VALUES (@NoSKL, @Nrp, @AwalLembur, @akhirLembur, @Aprove, @Total)"
                        ...
                        UpdateCommand="UPDATE Tbl_subSKL1 SET rejectHR = @rejectHR WHERE (ID = @ID)" ProviderName="<%$ ConnectionStrings:Data_abs1ConnectionString.ProviderName %>">
                        <DeleteParameters>
                            <asp:Parameter Name="ID" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
