...
Partial Class _HRGA_EditIO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If InStr(1, Session("jabatan").ToString, "Admin Payroll") = 0 And InStr(1, Session("jabatan").ToString, "ADMIN PAYROLL") = 0 And InStr(1, Session("ndPosisi").ToString, "PAYROLL") = 0 And InStr(1, Session("ndPosisi").ToString, "Admin Payroll") = 0 And InStr(1, Session("ndPosisi").ToString, "PAYROLL OFFICER") = 0  And InStr(1, Session("ndPosisi").ToString, "PAYROLL SITE OFFICER") = 0  And InStr(1, Session("Jabatan").ToString, "PAYROLL OFFICER") = 0  And InStr(1, Session("Jabatan").ToString, "PAYROLL SITE OFFICER") = 0 Then
