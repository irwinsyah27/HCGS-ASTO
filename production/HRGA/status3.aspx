<%@ Page Language="VB" MasterPageFile="~/HRGA/MasterHrga.master" AutoEventWireup="false" CodeFile="status3.aspx.vb" Inherits="HRGA_status3" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT [NoIjin], [Nrp], [Tanggal], [Awal], [Akhir], [Keperluan], [Requestor] FROM [tblIjin] WHERE [Persetujuan] = 0">
    </asp:SqlDataSource>
        ...
        <tr>
            ...
            <td style="width: 100px; height: 181px" valign="top"><fieldset style="padding-top: 3px">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    GridLines="None" Width="776px" AllowPaging="True" AllowSorting="True" PageSize="14">
