...
Partial Class _HRGA_Fixed_Asset
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("userid") = "" Then
            Session("Q") = "../Fixed_Asset.aspx"
            Response.Redirect("../login.aspx")
        End If
        'If InStr(1, Session("jabatan").ToString, "Admin Payroll") = 0 And InStr(1, Session("jabatan").ToString, "ADMIN PAYROLL") = 0 And InStr(1, Session("ndPosisi").ToString, "PAYROLL") = 0 And InStr(1, Session("ndPosisi").ToString, "Admin Payroll") = 0 Then
