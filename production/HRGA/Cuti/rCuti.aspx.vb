    ...
    Sub AwalCutiTahunan1()
        ...
        If CType(Me.DetailsView1.Rows(0).FindControl("txtAwal"), TextBox).Text <> "" Then
            ...
            If CType(Me.DetailsView1.Rows(0).FindControl("txtTahunan"), TextBox).Text <> "0" Or CType(Me.DetailsView1.Rows(0).FindControl("txtBesar"), TextBox).Text <> "0" Then
                ...
                'End If
                If CType(Me.DetailsView1.Rows(0).FindControl("txtPerjalanan"), TextBox).Text = 0 Then
                    CType(Me.DetailsView1.Rows(0).FindControl("txtAkhir"), TextBox).Text = Format(Format(temp1.AddDays(-1), "MM/dd/yyyy H:mm:ss"))
                Else
                    CType(Me.DetailsView1.Rows(0).FindControl("txtAkhir"), TextBox).Text = Format(Format(temp1, "MM/dd/yyyy H:mm:ss"))
                End If
            Else
                CType(Me.DetailsView1.Rows(0).FindControl("txtAkhir"), TextBox).Text = Format(CDate(CType(Me.DetailsView1.Rows(0).FindControl("txtAwal"), TextBox).Text).AddDays(CInt(CType(Me.DetailsView1.Rows(0).FindControl("txtLapangan"), TextBox).Text) - 1 + CInt(CType(Me.DetailsView1.Rows(0).FindControl("txtPerjalanan"), TextBox).Text)), "MM/dd/yyyy H:mm:ss")
            End If
        End If
        SisaCutiTahunan()
    End Sub
