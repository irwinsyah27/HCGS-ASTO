    ...
    Sub CariSC()
        ...
        If dr.Item("TglPersetujuan").ToString <> "" Then
            ...
            Else  'rubah dari hrga head ke pm'... gak sido..
                If InStr(1, Session("jabatan").ToString, "HRPGA DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRPGA DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRPGA SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRPGA Sect. Head") > 0 Then
                    Me.PanelHRPGA.Enabled = True
                    Me.txtPIC.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "HRPGA DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRPGA Dept. Head") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRPGA SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRPGA Sect. Head") > 0 Then
                    Me.PanelHRPGA.Enabled = True
                    Me.txtPIC.Enabled = True

                ElseIf InStr(1, Session("Dept").ToString, "HRPGA") > 0 And InStr(1, Session("Company").ToString, "KPP") > 0 Then
                    Me.PanelHRPGA.Enabled = True
                    Me.txtPIC.Enabled = True
