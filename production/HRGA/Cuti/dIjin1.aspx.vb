...
Partial Class HRGA_dIjin1
    ...
    Sub DataIjin()
        ...
        '====AturForm====================
        If InStr(1, Session("jabatan").ToString, "HEAD") > 0 or InStr(1, Session("ndPosisi").ToString, "HEAD") > 0 Then
        ...
        If InStr(1, Session("jabatan").ToString, "PERSONNEL ADMIN") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL OFFICER") > 0 Then
            Me.Panel4.Enabled = True
            'Me.btn3.Visible = True
        ElseIf InStr(1, Session("ndPosisi").ToString, "PERSONNEL ADMIN") > 0 Or InStr(1, Session("ndPosisi").ToString, "PAYROLL OFFICER") > 0 Then
            Me.Panel4.Enabled = True
            'Me.btn3.Visible = True
        Else
