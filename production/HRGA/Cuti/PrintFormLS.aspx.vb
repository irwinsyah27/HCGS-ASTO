...
Partial Class HRGA_Cuti_PrintForm
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If UCase(Right(y, 2)) = "SC" Then
            ReportViewer1.ServerReport.ReportPath = "/hrga/FormLS_Cuti_PER_NOMOR"
        ElseIf Right(y, 2) = "SD" Then
            ReportViewer1.ServerReport.ReportPath = "/hrga/FormLS_Dinas_Per_Nomor"
        ElseIf Right(y, 2) = "ST" Then
            ReportViewer1.ServerReport.ReportPath = "/hrga/FormLS_Tugas_Per_Nomor"
        End If
