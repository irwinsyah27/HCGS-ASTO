                ...
                <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; width: 101%;" valign="top">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #3366cc 1px solid;
                            ...
                            <tr>
                                <td style="width: 37%; text-align: right">
                                    <asp:Label ID="Label18" runat="server" Text="Dept Head : "></asp:Label></td>
                                <td style="width: 100%; height: 19px">
                            ...
                            <tr>
                                ...
                                <td style="width: 100%; height: 20px">
                                    &nbsp;<asp:RadioButton ID="ckSetuju" runat="server" GroupName="Persetujuan" Text="Menyetujui" Width="94px" />
                                    &nbsp; &nbsp;<asp:RadioButton ID="ckTidakSetuju" runat="server" GroupName="Persetujuan" Text="Tidak Menyetujui" Width="132px" /></td>
                            </tr>
                            <tr>
                                <td style="width: 37%; text-align: right">
                    ...
                    <asp:Panel ID="Panel2" runat="server" Height="100px" Width="100%" Visible="False">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #3366cc 1px solid;
                            ...
                            <tr>
                                <td style="width: 37%; text-align: right">
                                    <asp:Label ID="lblHrSecOrHrDeptHead" runat="server" Text="Hrpga Sect. Head/Hrpga Dept. Head : "></asp:Label></td>
                                <td style="width: 100%; height: 19px">
                    ...
                    <asp:Panel ID="Panel3" runat="server" Height="100%" Width="100%" Visible="False">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #3366cc 1px solid;
                            ...
                            <tr>
                                <td style="width: 37%; text-align: right; height: 19px;">
                                    <asp:Label ID="lblHrOrPm" runat="server" Text="Hrpga Dept. Head/Project Manager : "></asp:Label></td>
                                <td style="width: 100%; height: 19px">
