    ...
    Sub CariSC()
            ...
            ElseIf (dr.Item("Golongan").ToString) >= 19 Then
                ...
                If dr.Item("TglValidasi").ToString <> "" Then
                    ...
                    If dr.Item("ProjectManager").ToString <> "" Then
                        ...
                        'Proses Personnel---->>
                    Else
                        If InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0 Or InStr(1, Session("jabatan").ToString, "Project Manager") > 0 Or InStr(1, Session("jabatan").ToString, "HRPGA DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRPGA Dept. Head") > 0 Then
                            Me.Panel1.Enabled = True
                            Me.Panel3.Enabled = True
                        ElseIf InStr(1, Session("ndPosisi").ToString, "PROJECT MANAGER") > 0 Or InStr(1, Session("ndPosisi").ToString, "Project Manager") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRPGA DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRPGA Dept. Head") > 0 Then
                            Me.Panel1.Enabled = True
                            Me.Panel3.Enabled = True
                        Else
                            Me.Panel3.Enabled = False
        ...
        Else
            ...
            If InStr(1, Jabatan, "DEPT. HEAD") > 0 Or InStr(1, Jabatan, "Dept. Head") > 0 Then
                ...
                End If
            Else
                If (Trim(dr.Item("Departemen").ToString) = Trim(Session("dept").ToString)) Or (InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0) Or (InStr(1, Session("ndPosisi").ToString, "PROJECT MANAGER") > 0) Or (InStr(1, Session("jabatan").ToString, "Project Manager") > 0) Or (InStr(1, Session("ndPosisi").ToString, "Project Manager") > 0) Then
