<%@ Page Language="VB" Debug="TRUE"  AutoEventWireup="false" CodeFile="eCuti1.aspx.vb" Inherits="_eCuti1" %>
...
<body>
    ...
    <div><fieldset>
        ...
        <table border="0" cellpadding="5" cellspacing="0" style="width: 100%; height: 100%" id="TABLE1" language="javascript" onclick="return TABLE1_onclick()">
            <tr>
                <td valign="top" align="center" style="width: 98%; height: 48px;">
                        ...
                        <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="1" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 212px; height: 19px" align="right">
                                            <asp:TextBox ID="txtTujuan" runat="server" Width="200px"></asp:TextBox>&nbsp;</td>
                            ...
                            <td valign="top" style="height: 135px; width: 390px;">
                                <table border="0" cellpadding="0" cellspacing="1" style="width: 100%">
                                    ...
                                    <tr>
                                        <td align="right" style="height: 19px">
                                            <asp:Label ID="Label40" runat="server" Text="Sisa Cuti Besar : " Width="152px"></asp:Label></td>
                                        <td align="right" style="width: 106%">
                                            <asp:Label ID="lblSisaCutiBesar" runat="server" Font-Size="10pt"></asp:Label>
                                            <asp:Label ID="Label43" runat="server" Font-Size="10pt">hari</asp:Label></td>
                                        <td align="right" style="width: 100px; height: 19px">
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td colspan="2" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
		                            ...
		                            href="javascript:;"><IMG src="Images/Calendar.png" border="0" id="IMG1" runat="server" align="absMiddle" height="20" width="20"></A>
                                        ...
                                        <td style="width: 100%; height: 24px;">
                                            &nbsp;<asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtLapangan"
                                                ErrorMessage="*" MaximumValue="12" MinimumValue="0" Type="Integer"></asp:RangeValidator><A onclick="window.open('PopupCal.aspx?FormName=' + document.forms[0].name + '&textbox=txtAkhir','PopupClass','width=215,height=195,left=330,top=300')"
		                            href="javascript:;"></A>
                                            </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="height: 19px">
                                            <asp:TextBox ID="txtAlamatCuti" runat="server" Width="80%"></asp:TextBox>
