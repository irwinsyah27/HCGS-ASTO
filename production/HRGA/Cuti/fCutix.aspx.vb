...
Partial Class _fCuti1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'untuk proteksi data.... input cuti spesial oleh hr only....'
        If Session("userid") = "" Then
            Session("Q") = "./cuti/fCutix.aspx"
            Response.Redirect("../login.aspx")
        End If

        If InStr(1, Session("jabatan").ToString, "PERSONNEL") = 0 Then
        ...
        ''If Session("Jabatan") <> "KORLAP" Then
        'If InStr(1, Session("jabatan").ToString, "PAYROLL") = 0 Or InStr(1, Session("jabatan").ToString, "PERSONNEL") = 0 Then
        '    If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
        '        Dim cstext1 As String = "alert('Cuti Labour Supply hanya boleh diinput oleh Koordinator Lapangan   ');self.close();"
        '        cs.RegisterStartupScript(cstype, csname1, cstext1, True)
        '        Exit Sub
        '    End If
        'End If
        '' end off hr only spesial
