    ...
    Sub CariSC()
        ...
        If dr.Item("TglValidasi").ToString <> "" Then
            ...
            If dr.Item("ProjectManager").ToString <> "" Then
                ...
                'Proses Personnel---->>
            Else
                If InStr(1, Session("jabatan").ToString, "HRPGA DEPT. HEAD") > 0 Then
                    Me.Panel3.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "HRPGA DEPT. HEAD") > 0 Then
                    Me.Panel3.Enabled = True
                Else
                    Me.Panel3.Enabled = False
                End If
            End If
        Else
            If InStr(1, Session("jabatan").ToString, "HRPGA SECT. HEAD") > 0 Then
                Me.Panel2.Enabled = True
            ElseIf InStr(1, Session("ndPosisi").ToString, "HRPGA SECT. HEAD") > 0 Then
                Me.Panel2.Enabled = True
            Else
                Me.Panel2.Enabled = False
                Me.btnSetujuHrga.Visible = False
