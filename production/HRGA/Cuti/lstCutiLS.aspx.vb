...
Partial Class lstCuti
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If InStr(1, Session("jabatan").ToString, "KORLAP DAB") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP GNI") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP SIGAP") > 0 Or InStr(1, Session("jabatan").ToString, "Korlap") > 0 Then
