<?php
	...
	if ($_SESSION['User']) {
		...
		echo ("<meta http-equiv=refresh content=1;url=http://pabbapco401.kppmining.net:83/SessionOff.php>");
		exit();	
	}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://pabbapco401.kppmining.net:83/tools/layout-default-latest.css" />
	<link rel="stylesheet" type="text/css" href="http://pabbapco401.kppmining.net:83/tools/themes/south-street/jquery.ui.all.css" />
	<!-- CUSTOMIZE/OVERRIDE THE DEFAULT CSS -->
	<link href="http://pabbapco401.kppmining.net:83/Tools/css/style.css" rel="stylesheet" type="text/css" media="screen" />
	<link media="screen" href="http://pabbapco401.kppmining.net:83/Tools/jquery.msg.css" rel="stylesheet" type="text/css">
	<link media="screen" href="http://pabbapco401.kppmining.net:83/Chatting/css/chat.css" rel="stylesheet" type="text/css">
	<link media="screen" href="http://pabbapco401.kppmining.net:83/Chatting/css/screen_ie.css" rel="stylesheet" type="text/css">
	<style type="text/css">
	...
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/tools/jquery-latest.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/tools/jquery-ui-latest.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/tools/jquery.layout-latest.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/tools/jquery.layout.resizePaneAccordions-1.0.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/Tools/jquery.center.min.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/Tools/jquery.msg.min.js"></script>
	<script type="text/javascript" src="http://pabbapco401.kppmining.net:83/Tools/chat.js"></script>
...
<div class="ui-layout-north ui-widget-content" style="display: none;">
			<div class="item">
                ...
                <div class="item_content">
                    <h2>LogOff</h2>
                    <pM>
                        <a href="http://pabbapco401.kppmining.net:83/SessionOff.php" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Logoff</a>
					</pM>
				</div>
            </div>
			<div class="item">
                ...
                <div class="item_content">
                    ...
                    <pM>
                        ...
                        <a href="http://pabbapco401.kppmining.net:83/Tools/extlpn.pdf" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Go</a>
					</pM>
				</div>
            </div>
			<div class="item">
                ...
                <div class="item_content">
                    ...
                    <pM>
                        ...
                        <a href="http://pabbapco401.kppmining.net:83/TaskFlow/Utama.php" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">TaskFlow</a>
                        <a href="http://pabbapco401.kppmining.net:83/SHES/Utama.php" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">SMS</a>
			...
			<div class="item">
                ...
                <div class="item_content">
                    ...
                    <pM>
                        ...
                        <a href="http://pabbapco401.kppmining.net:83/EWACS/Index.htm" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Ewacs</a>
                        <a href="http://pabbapco401.kppmining.net:83/Budget/Screen.php" target="kanan" onclick="$.msg({fadeIn : 500, fadeOut : 500, timeOut : 5000});">R-bu-S</a>
                        <a href="http://pabbapco401.kppmining.net:83/Sigap/Utama.php" target="kanan" onclick="$.msg({fadeIn : 200, fadeOut : 200, timeOut : 500});">Security</a>
                    </pM>
                </div>
            </div>
            <div class="item">
...
<div class="ui-layout-center" style="display: none;"> 
	...
	<!-- <div class="ui-layout-content ui-widget-content"> -->
		<iframe src="<?php if($Link!=''){echo $Link;} else { echo "http://pabbapco401.kppmining.net:83/Berita/NilaiInti.php";} ?>" id="kanan" name="kanan" width="100%" height="100%" align="Center" hspace="0" vspace="0" scrollbar="yes"> </iframe>
	<!-- </div> -->
</div>
...
<div class="ui-layout-east" style="display: none;">
	...
	<!-- script untuk Menu -->
    <script type="text/javascript" src="http://pabbapco401.kppmining.net:83/tools/jquery-animate-css-rotate-scale.js"></script>
	<script>
            $('.item').hover(
                function(){
                    var $this = $(this);
