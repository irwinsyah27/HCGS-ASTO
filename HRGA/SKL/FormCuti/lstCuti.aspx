<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="lstCuti.aspx.vb" Inherits="lstCuti" title="List Surat Cuti" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
        DataKeyNames="NomorST" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None"
        Width="100%" Font-Overline="False" Font-Size="10pt" AllowSorting="True">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT tblSutu.NomorST, tblKaryawan.Nama, tblSutu.Nrp, tblKaryawan.Jabatan, tblKaryawan.Departemen, tblSutu.Tujuan, tblSutu.Awal, tblSutu.Akhir, tblSutu.Keperluan FROM tblKaryawan INNER JOIN tblSutu ON tblKaryawan.Nrp = tblSutu.Nrp Where Keperluan Like '%CUTI%'">
    </asp:SqlDataSource>
</asp:Content>
