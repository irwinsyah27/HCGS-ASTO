    ...
    Sub CariSC()
        ...
        Else
            If Trim(dr.Item("Departemen").ToString) = Trim(Session("dept").ToString) Then
                'Response.Write("1 " & Session("ndPosisi").ToString)
                If InStr(1, Session("jabatan").ToString, "DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "SECT. HEAD") > 0 Then
                    Response.Write("1 " & Session("ndPosisi").ToString)
                    Me.Panel1.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SECT. HEAD") > 0 Then
                    Me.Panel1.Enabled = True
                Else
                    Me.Panel1.Enabled = False
                End If
