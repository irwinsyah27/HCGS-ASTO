...
Partial Class aprovehr
    ...
    Function cek1()
        ...
        '---------------YG(BARU)
        If InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "PERSONNEL OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRGA TUTUPAN SECT. HEADD") > 0 Then
            cekisi1()
        ElseIf InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("ndposisi").ToString, "PERSONNEL OFFICER") > 0 Or InStr(1, Session("ndposisi").ToString, "PAYROLL OFFICER") > 0 Or InStr(1, Session("ndposisi").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("ndposisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndposisi").ToString, "HRGA TUTUPAN SECT. HEADD") > 0 Then
            cekisi1()
        ElseIf InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "Personnel Officer") > 0 Or InStr(1, Session("jabatan").ToString, "Payrool Officer") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Then
            cekisi1()
        ElseIf InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("ndposisi").ToString, "Personnel Officer") > 0 Or InStr(1, Session("ndposisi").ToString, "Payrool Officer") > 0 Or InStr(1, Session("ndposisi").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("ndposisi").ToString, "HCGS SECT. HEAD") > 0 Then
            cekisi1()
        Else
