...
Partial Class HRGA_SKL_SKaEl_Ha
    ...
    Protected Sub calawallbr_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles calawallbr.SelectionChanged
        'If Me.calawallbr.SelectedDate.Date >= Date.Today.AddDays(-7) Then
            ...
            Session("tglawal") = Format((Me.calawallbr.SelectedDate), "dd/MM/yyyy").ToString
            Me.btnawallbr.Visible = False
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If InStr(1, Session("LStatus").ToString, "AdminSKL") = 0 Then
                ...
                Me.btnawallbr.Visible = False
                If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                    Dim cstext1 As String = "alert('Anda bukan termasuk Admin SKL, harap hubungi Dept. HCGS');"
                    cstext1 += "self.close();"
                    cs.RegisterStartupScript(cstype, csname1, cstext1, True)
                    Exit Sub
                End If
    ...
    Protected Sub txtnrp_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtnrp.TextChanged
        ...
        If dr.Read = True Then
            ...
            End If
                ...
                If dr.Item("onsite").ToString <> True Then
                    If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                        Dim cstext1 As String = "alert('Nrp " & Me.txtnrp.Text & " bukan karyawan Site ASTO...    ');"
                        cs.RegisterStartupScript(cstype, csname1, cstext1, True)
                        Exit Sub
                    End If
                End If
    ...
    Protected Sub btnsend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsend.Click
        ...
        End If
        If Len(nomer) = 1 Then
            nomer = Session("Site").ToString & "/HC./" & th2 & "/0000" & nomer & "/SK7"
        ElseIf Len(nomer) = 2 Then
            nomer = Session("Site").ToString & "/HC./" & th2 & "/000" & nomer & "/SK7"
        ElseIf Len(nomer) = 3 Then
            nomer = Session("Site").ToString & "/HC./" & th2 & "/00" & nomer & "/SK7"
        ElseIf Len(nomer) = 4 Then
            nomer = Session("Site").ToString & "/HC./" & th2 & "/0" & nomer & "/SK7"
        ElseIf Len(nomer) = 5 Then
            nomer = Session("Site").ToString & "/HC./" & th2 & "/" & nomer & "/SK7"
        End If
        con.Close()
        ''=====
        ...
        If "1" = "1" Then
            ...
            With cmd2
                ...
                .Parameters.Add("@No", SqlDbType.VarChar, 25)
                .Parameters.Add("@Nrp", SqlDbType.VarChar, 10)
