...
Partial Class aprove
    ...
    Function cekisi1()
        ...
        If dr.Read Then
            ...
            If (Trim(dr.Item(9).ToString) = Session("dept").ToString) And (Session("dept").ToString <> "HAULING" Or Session("dept").ToString <> "RM") Then
                ...
                End If
            Elseif (Trim(dr.Item(9).ToString) = "HAULING" Or Trim(dr.Item(9).ToString) = "RM") And ( Session("dept").ToString = "HAULING" Or Session("dept").ToString = "RM")
                 If dr.Item(6).ToString <> "" Then
                    aprove()
                Else
                    Me.GridView2.Columns(8).Visible = True
