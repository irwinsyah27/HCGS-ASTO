...
Partial Class aprovehr
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("Dept") = "" Then
            Session("Q") = "skl/aprovehr040308.aspx?n=" & Request.QueryString("n").ToString
    ...
    Protected Sub btnrejecthr_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnrejecthr.Click
        ...
        With cmd2
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "update tbl_skl1 set nrphr=@nrphr, tglhraproved=getdate(), catatanhr=@catatanhr, aprovehr='0' where noskl='" & Request.QueryString("n").ToString & "'"
            '.CommandText = "Insert Into tbl_skl (NoSKL,NRPrequestor,TglCreated,uraianLembur) Values(@NoSKL,@NrpUser,getdate(),@uraianlembur)"
    ...
    Function prosesi()
        ...
        With cmd
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "select A.Noskl, A.nrpaproved, A.tglaproved, B.nama, A.Catatan,A.proses FROM tbl_skl1 A INNER JOIN karyawan B ON A.nrpaproved=B.nrp WHERE A.NOSKL='" & Request.QueryString("n").ToString & "'"
