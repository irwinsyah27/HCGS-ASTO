...
Partial Class vwskl
    ...
    Function cekhr()
        ...
        With cmd
            ...
            .CommandText = "SELECT A.NoSKL, B.Nrp, B.AwalLembur, B.akhirLembur, A.Aprovehr, B.Totalhr, A.NRPhr, A.TglhrAproved, A.Catatanhr, c.Dept, c.NAMA FROM Tbl_SKL A INNER JOIN Tbl_subSKL B ON A.NoSKL = B.NoSKL LEFT JOIN Karyawan C ON A.Nrphr = C.Nrp WHERE A.NOSKL='" & Request.QueryString("n").ToString & "'"
            dr = .ExecuteReader
