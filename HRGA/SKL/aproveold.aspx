<%@ Page Language="VB" debug="true"MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="aproveold.aspx.vb" Inherits="Default4" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        DataSourceID="SqlDataSource2" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True">
        <Columns>
            <asp:CommandField ShowEditButton="True" Visible="False" EditText="Aprove" UpdateText="OK" />
            <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
                SortExpression="ID" Visible="False" />
            <asp:BoundField DataField="NoSKL" HeaderText="NoSKL" SortExpression="NoSKL" ReadOnly="True" />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Data_abs1ConnectionString %>"
        ...
        <tr>
            <td style="border-right: black 2px solid; border-top: black 2px solid; font-weight: bold; text-transform: uppercase; border-left: black 2px solid; color: maroon; border-bottom: silver 1px dashed; font-family: 'Baskerville Old Face', Fantasy; height: 19px; background-color: silver; text-decoration: underline;" colspan="3">
                ATASAN :</td>
            <td style="width: 20%; height: 19px;">
            </td>
        </tr>
        <tr>
            <td id="RR" align="center" colspan="3" style="border-right: black 2px solid; border-left: black 2px solid;
                width: 5%; border-bottom: maroon 1px solid; height: 19px; background-color: floralwhite; color: floralwhite;">
                <asp:Label ID="Label5" runat="server" Visible="False" style="color: black"></asp:Label>111</td>
            <td style="width: 20%; height: 19px">
            </td>
        </tr>
        <tr>
            <td style="width: 5%; border-left: black 2px solid; background-color: floralwhite; border-top-width: 1px; border-bottom-width: 1px; border-bottom-color: maroon; color: floralwhite; border-top-color: maroon; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="lblnama" runat="server" Text="Nama" Visible="False" style="color: black"></asp:Label>nama</td>
            <td align="center" style="width: 5%; background-color: floralwhite; border-top-width: 1px; border-bottom-width: 1px; border-bottom-color: maroon; color: floralwhite; border-top-color: maroon; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Black"
                    Text=":" Width="50%" Visible="False"></asp:Label></td>
            <td style="width: 55%; border-right: black 2px solid; background-color: floralwhite; height: 21px; border-top-width: 1px; border-left-width: 1px; border-left-color: maroon; border-bottom-width: 1px; border-bottom-color: maroon; color: floralwhite; border-top-color: maroon;">
                <asp:Label ID="lblnama1" runat="server" Visible="False" style="color: black"></asp:Label>kk</td>
            <td style="width: 20%; height: 19px;">
            </td>
        </tr>
        <tr>
            <td style="width: 20%; height: 13px; border-top: maroon 1px solid; border-left: black 2px solid; border-bottom: maroon 1px solid; background-color: floralwhite; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="lblnrp" runat="server" Text="Nrp" Visible="False"></asp:Label></td>
            <td align="center" style="width: 5%; height: 13px; border-bottom: maroon 1px solid; background-color: floralwhite; border-top: maroon 1px solid; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Black"
                    Text=":" Width="50%" Visible="False" style="border-top-width: 1px; border-top-color: maroon"></asp:Label></td>
            <td style="width: 55%; height: 13px; border-right: black 2px solid; border-bottom: maroon 1px solid; background-color: floralwhite; border-top: maroon 1px solid;">
                <asp:Label ID="lblnrp1" runat="server" Visible="False"></asp:Label></td>
            <td style="width: 20%; height: 13px;">
            </td>
        </tr>
        <tr>
            <td style="width: 20%; border-left: black 2px solid; border-bottom: maroon 1px solid; background-color: floralwhite; border-top-width: 1px; border-top-color: maroon; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="lbltgl" runat="server" Text="Tanggal Persetujuan" Visible="False"></asp:Label></td>
            <td align="center" style="width: 5%; border-bottom: maroon 1px solid; background-color: floralwhite; border-top-width: 1px; border-top-color: maroon; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Black"
                    Text=":" Width="50%" Visible="False"></asp:Label></td>
            <td style="width: 55%; border-right: black 2px solid; border-bottom: maroon 1px solid; background-color: floralwhite;">
                <asp:Label ID="lbltgl1" runat="server" Visible="False"></asp:Label></td>
            <td style="width: 20%;">
            </td>
        </tr>
        <tr>
            <td style="width: 20%; height: 19px; border-left: black 2px solid; border-bottom: black 2px solid; background-color: floralwhite; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="lblCatatan" runat="server" Text="Catatan" Visible="False" Width="98%"></asp:Label></td>
            <td align="center" style="width: 5%; border-bottom: black 2px solid; background-color: floralwhite; border-right-width: 1px; border-right-color: maroon;">
                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Black"
                    Text=":" Width="50%" Visible="False"></asp:Label></td>
            <td style="width: 55%; height: 21px; border-right: black 2px solid; border-bottom: black 2px solid; background-color: floralwhite;">
                <asp:TextBox ID="txtcatatan" runat="server" Height="90px" Visible="False" Width="98%" AutoPostBack="True"></asp:TextBox>
                <asp:Label ID="LBLCAT1" runat="server" Visible="False"></asp:Label></td>
            <td style="width: 20%; height: 19px">
            </td>
        </tr>
        <tr>
            <td align="center" colspan="3" style="border-top-width: 2px; border-right: black 2px solid; border-left: black 2px solid; width: 5%; border-top-color: black; border-bottom: black 2px solid; background-color: floralwhite; height: 31px;">
                <asp:Label ID="lblcat" runat="server" Font-Underline="True" ForeColor="Red" Visible="False"></asp:Label>
                <asp:Button ID="btnsend" runat="server" Text="APROVE" Visible="False" Enabled="False" />
        ...
        <tr>
            ...
            <td style="width: 55%; height: 21px; border-bottom-width: 1px; border-bottom-color: maroon; border-right-width: 2px; border-right-color: black;">
            </td>
            <td style="width: 20%; height: 19px">
            </td>
        </tr>
