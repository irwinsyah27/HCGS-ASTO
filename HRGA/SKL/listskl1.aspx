...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Data_abs1ConnectionString %>"
        SelectCommand="SELECT TOP 1000 Tbl_SKL1.NoSKL, Tbl_SKL1.TglCreated, Tbl_SubSKL1.Nrp, Karyawan.NAMA, Karyawan.Dept, Tbl_subSKL1.AwalLembur, Tbl_subSKL1.akhirLembur, Tbl_SKL1.UraianLembur, Tbl_SKL1.AproveDept, Tbl_SKL1.AproveHR 
FROM Karyawan INNER JOIN Tbl_subSKL1 ON Karyawan.Nrp = Tbl_subSKL1.Nrp INNER JOIN Tbl_SKL1 ON Tbl_subSKL1.NoSKL = Tbl_SKL1.NoSKL  WHERE (Karyawan.Dept = @Dept) 
AND (Lokasi=@Site OR @Jabatan LIKE '%PERSONNEL SITE%' OR @Jabatan LIKE '%HRM & ENGINEERING DEPT. HEAD%'  OR @Jabatan LIKE '%PROJECT MANAGER%' OR @Jabatan LIKE '%SHE DEPT. HEAD%' OR @Jabatan LIKE '%BPI SITE OFFICER%' OR @Jabatan LIKE '%HCGS & FAT DEPT. HEAD%' OR @Jabatan LIKE '%HCGS SECT. HEAD%' OR @Jabatan LIKE '%PAYROLL OFFICER%' OR @CNRP = 'DR00169' OR @CNRP = 'KC09056' OR @CNRP = 'KC04059' OR @CNRP = 'KB11082')
order by tbl_skl1.Noskl Desc">
        <SelectParameters>
