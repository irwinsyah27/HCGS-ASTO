<%@ Page Language="VB" MasterPageFile="~/HRGA/MasterHrga.master" AutoEventWireup="false" CodeFile="status2.aspx.vb" Inherits="HRGA_status2" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT [NoIjin], [Nrp], [Tanggal], [Awal], [Akhir], [Keperluan], [Requestor] FROM [tblIjin] WHERE [Persetujuan] =1">
    </asp:SqlDataSource>
</asp:Content>
