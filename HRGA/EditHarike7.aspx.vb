...
Partial Class HRGA_EditHarike7
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        If InStr(1, Session("AccessAdm").ToString, "True") = 0 And InStr(1, Session("Jabatan").ToString, "Plan Site Admin") = 0 And InStr(1, Session("Jabatan").ToString, "PERSONNEL ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "ADMIN SUBCONT") = 0 And InStr(1, Session("Jabatan").ToString, "PLANT ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "HAULING ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "RM ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "ENG ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "SM ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "SHE ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "PAYROLL SITE OFFICER") = 0 And InStr(1, Session("Jabatan").ToString, "ADMIN") = 0 And InStr(1, Session("Jabatan").ToString, "KORLAP") = 0 Then
            If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
