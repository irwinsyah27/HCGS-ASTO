<%@ Page Language="VB" MasterPageFile="MasterHrga.master" AutoEventWireup="false" CodeFile="MasterKaryawanPama.aspx.vb" Inherits="HRGA_MasterKaryawanPama" title="Karyawan Pama" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT [Nrp], [Nama], [TempatLahir], [TglLahir], [JenisKelamin], [GolonganDarah], [TglMasukPama], [StatusPenerimaan], [Company], [SisaCutiPeriode1], [SisaCutiPeriode2], [SisaCutiBesar] FROM [tblKaryawan] Where [StatusPenerimaan] IN ('LOKAL','KIRIMAN','LS') And ([Nrp] = @NRP OR @NRP = 'ALL') AND ONSITE = 1 And Company Like @Company AND Departemen Like @DEPT UNION &#13;&#10;SELECT '0' AS [Nrp], NULL AS [Nama],  NULL AS [TempatLahir], NULL AS [TglLahir],NULL AS [JenisKelamin],  NULL AS [GolonganDarah],NULL AS [TglMasukPama],NULL AS [StatusPenerimaan],NULL AS [Company], NULL AS [SisaCutiPeriode1], NULL AS [SisaCutiPeriode2], NULL AS [SisaCutiBesar] FROM [tblKaryawan] &#13;&#10;Where (Lokasi=@Site OR Jabatan LIKE '%PERSONNEL SITE%' OR Jabatan LIKE '%ENG DEPT. HEAD%'  OR Jabatan LIKE '%PROJECT MANAGER%' OR Jabatan LIKE '%BPI SITE OFFICER%' OR Jabatan LIKE '%FAT DEPT. HEAD%') AND ONSITE = 1">
        <SelectParameters>
