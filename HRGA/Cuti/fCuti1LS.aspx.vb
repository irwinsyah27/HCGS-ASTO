...
Partial Class _fCuti1LS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With cmd
            ...
            .CommandText = "Select Nrp, Nama, StatusPenerimaan, Company, Jabatan, Golongan, Departemen, StatusPenerimaan, StatusKawin, StatusBawaKeluarga, AlamatTinggal, Telepon  From vw_tblKaryawan Where Nrp = @Nrp"
        ...
        If Me.txtAwal.Text <> "" Then
           ...
           ' AwalCTahunan = AwalCTahunan.AddDays(Me.txtPerjalananAwal.Text)
            ...
            If Me.txtTahunan.Text <> "0" Or Me.txtBesar.Text <> "0" Then
				...
				'Response.Write("perjalanan before = " & Me.txtPerjalanan.Text)
				'Response.Write("perjalanan after = " & CInt(Me.txtPerjalanan.Text)-1)
				
				'Response.Write("temp1 before = " & temp1)
				
				if Me.txtPerjalanan.Text <> "0" then 'penghitungan NRP lokal tanpa perjalanan
					temp1 = temp1.AddDays(CInt(Me.txtPerjalanan.Text)-1)	
                end if		
				
				'Response.Write("temp1 after = " & temp1)
    ...
    Protected Sub btSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btSave.Click
        ...
        If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
            ...
            Dim cstext1 As String = "alert('Surat Cuti Sudah tersimpan !');"
            cstext1 += "self.close();"
        ...
        '    Dim cstype1 As Type = Me.GetType()
         '  Dim cs1 As ClientScriptManager = Page.ClientScript
          '  If (Not cs1.IsStartupScriptRegistered(cstype1, csname11)) Then
           '     Dim cstext11 As String = "alert('Awal cuti hanya bisa dinput, max. 14 hari sebelum waktu cuti....harap hubungi team HRPGA..');"
                'cstext1 += "self.close();"
            '    Me.txtAwal.Text = ""
             '   Me.txtAkhir.Text = ""
