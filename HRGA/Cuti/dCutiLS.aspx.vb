...
Partial Class HRGA_Cuti_dCutiLS
    ...
    Sub AwalCutiTahunan()
        ...
        If Me.txtAwal.Text <> "" Then
            ...
            If Me.txtTahunan.Text <> "0" Or Me.txtBesar.Text <> "0" Then
                ...
                End If
            Else
                Me.txtAkhir.Text = Format(CDate(txtAwal.Text).AddDays(CInt(Me.txtLapangan.Text) - 1 + CInt(Me.txtPerjalanan.Text)+ 1), "dd MMM yyyy")
            End If
        End If
    ...
    Sub CariSC()
        ...
        If dr.Read = True Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                ...
                ElseIf CBool(dr.Item("PersetujuanHrga").ToString) = False Then
                    Me.ckHrgaTidakSetuju.Checked = False
                End If
            End If
            ''Persetujuan PM/HRGA
            ...
            '    If InStr(1, Session("jabatan").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL") > 0 Then
            '        Me.Panel4.Visible = True
            '    ElseIf InStr(1, Session("ndPosisi").ToString, "PERSONNEL SITE OFFICER") > 0 Or InStr(1, Session("ndPosisi").ToString, "PAYROLL") > 0 Then
            '        Me.Panel4.Visible = True
            '    Else
            '        Me.Panel4.Visible = True
        ...
        If dr.Item("PersetujuanAtasan").ToString <> "" Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                Me.Panel2.Enabled = False
            Else
                If InStr(1, Session("jabatan").ToString, "HCGS SECT.HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENG DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PLANT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PLANT SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENG SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "SHE DEPT. HEAD") > 0 Then
                    Me.Panel2.Enabled = True
                    Me.btnVerifikasi.Enabled = True
                    'ElseIf InStr(1, Session("ndPosisi").ToString, "SECT. HEAD") > 0 Then
                ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS SECT.HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENG DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PLANT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PLANT SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENG SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SHE DEPT. HEAD") > 0 THEN
        ...
        Else
            'If Trim(dr.Item("Departemen").ToString) = Trim(Session("dept").ToString) Then
                ...
                If InStr(1, Session("jabatan").ToString, "PERSONNEL ADMIN") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "GS SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "Personnel Admin") > 0 Or InStr(1, Session("jabatan").ToString, "Payroll Site Officer") > 0 Or InStr(1, Session("jabatan").ToString, "GS Site Officer") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP ERM") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP Solid") > 0 Or InStr(1, Session("jabatan").ToString, "KORLAP TEGAP") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PLANNER") > 0 Or InStr(1, Session("jabatan").ToString, "ROAD MAINTENANCE GL") > 0 Or InStr(1, Session("jabatan").ToString, "SSE GL") > 0 Or InStr(1, Session("jabatan").ToString, "TYRE GL") > 0 Or InStr(1, Session("jabatan").ToString, "WHEEL TYPE GL") > 0 Or InStr(1, Session("jabatan").ToString, "PLANT GL") > 0 Or InStr(1, Session("jabatan").ToString, "PLANT HAULING GL") > 0 Or InStr(1, Session("jabatan").ToString, "HAULING GL") > 0 Or InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0 Or InStr(1, Session("jabatan").ToString, "Project Manager") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "SHE SITE DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRM SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PLANNER") > 0 Or InStr(1, Session("jabatan").ToString, "INVENTORY & PURCHASING GL") > 0 Or InStr(1, Session("jabatan").ToString, "SHE DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PLANT DEPT. HEAD") > 0 Then
                    'Response.Write("1 " & Session("ndPosisi").ToString)
                    Me.Panel1.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "PERSONNEL ADMIN") > 0 Or InStr(1, Session("ndPosisi").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("ndPosisi").ToString, "GS SITE OFFICER") > 0 Or InStr(1, Session("ndPosisi").ToString, "Personnel Admin") > 0 Or InStr(1, Session("ndPosisi").ToString, "Payroll Site Officer") > 0 Or InStr(1, Session("ndPosisi").ToString, "GS Site Officer") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP ERM") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP Solid") > 0 Or InStr(1, Session("ndPosisi").ToString, "KORLAP TEGAP") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PLANNER") > 0 Or InStr(1, Session("ndPosisi").ToString, "ROAD MAINTENANCE GL") > 0 Or InStr(1, Session("ndPosisi").ToString, "SSE GL") > 0 Or InStr(1, Session("ndPosisi").ToString, "WHEEL TYPE GL") > 0 Or InStr(1, Session("ndPosisi").ToString, "PLANT GL") > 0 Or InStr(1, Session("ndPosisi").ToString, "HAULING GL") > 0 Or InStr(1, Session("ndPosisi").ToString, "PROJECT MANAGER") > 0 Or InStr(1, Session("ndPosisi").ToString, "Project Manager") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SHE SITE DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 or InStr(1, Session("ndPosisi").ToString, "SHE DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PLANT DEPT. HEAD") > 0 Then
                    Me.Panel1.Enabled = True
                Else
                    Me.Panel1.Enabled = False
                End If
        ...
        End If
            ...
            Else
                If InStr(1, Session("jabatan").ToString, "PERSONNEL ADMIN") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "GS SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "Personnel Admin") > 0 Or InStr(1, Session("jabatan").ToString, "Payroll Site Officer") > 0 Or InStr(1, Session("jabatan").ToString, "GS Site Officer") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Then
                    ...
                    Me.Panel2.Visible = False
                ElseIf InStr(1, Session("jabatan").ToString, "PERSONNEL ADMIN") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "GS SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "Personnel Admin") > 0 Or InStr(1, Session("jabatan").ToString, "Payroll Site Officer") > 0 Or InStr(1, Session("jabatan").ToString, "GS Site Officer") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Then
                    Me.Panel4.Visible = True
                    Me.btnVerifikasi.Visible = True
                    Me.btRevisiHr.Visible = True
                    Me.Panel2.Visible = False
    ...
    Protected Sub btnSetujuHrga_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSetujuHrga.Click
        ...
        With cmd
            ...
            '.Parameters("@Persetujuanhr").Value = "1"
