    ...
    Sub CariSC()
        ...
        With cmd
            ...
            .CommandText = "SELECT     tblSutu.NomorST, tblSutu.Nrp, vw_tblKaryawan.Nama, tblSutu.tglST, tblSutu.Tujuan, tblSutu.Keperluan, tblSutu.Penginapan, tblSutu.Hari, tblSutu.Awal, " _
                      ...
                      & "tblSutu.HR_Officer, tblSutu.VerifikasiHR, tblSutu.TglVerifikasi, tblSutu.PersetujuanHr, tblSutu.PersetujuanHrga, tblSutu.PersetujuanPm, tblSutu.HRGA_Head, tblSutu.TglValidasi, tblSutu.CatatanHrga, tblSutu.ProjectManager, tblSutu.TglPersetujuanPM, tblSutu.CatatanPM, tblSutu.DibuatOleh, " _
                        ...
                        & "vw_tblKaryawan_4.Nama AS NamaHR_Officer, vw_tblKaryawan_4.Jabatan AS JabatanHROfficer, vw_tblKaryawan.Departemen, vw_tblKaryawan.Golongan, vw_tblKaryawan.MasaDinas " _
        ...
        If dr.Read = True Then
            ...
            If dr.Item("MasaDinas").ToString = "12" Then
                    Me.txtAkhir.Text = Format(CDate(dr.Item("Awal").ToString).AddDays(83), "dd MMM yyyy")
                    Me.txtHari.Text = 83
            ElseIf dr.Item("MasaDinas").ToString = "13" Then
                    Me.txtAkhir.Text = Format(CDate(dr.Item("Awal").ToString).AddDays(90), "dd MMM yyyy")
                    Me.txtHari.Text = 90
            ElseIf dr.Item("MasaDinas").ToString = "8" Then
                    Me.txtAkhir.Text = Format(CDate(dr.Item("Awal").ToString).AddDays(55), "dd MMM yyyy")
                    Me.txtHari.Text = 55
            ElseIf dr.Item("MasaDinas").ToString = "11" Then
                    Me.txtAkhir.Text = Format(CDate(dr.Item("Awal").ToString).AddDays(76), "dd MMM yyyy")
                    Me.txtHari.Text = 76
            ElseIf dr.Item("MasaDinas").ToString = "10" Then
                    Me.txtAkhir.Text = Format(CDate(dr.Item("Awal").ToString).AddDays(69), "dd MMM yyyy")
                    Me.txtHari.Text = 69
            ElseIf dr.Item("MasaDinas").ToString = "6" Then
                    Me.txtAkhir.Text = Format(CDate(dr.Item("Awal").ToString).AddDays(41), "dd MMM yyyy")
                    Me.txtHari.Text = 41
            End If
        ...
        If (dr.Item("Golongan").ToString) <= 18 Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                ...
                Else  'rubah dari hrga head ke pm'... gak sido..
                    If InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Then
                        Me.Panel3.Enabled = True
                    ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS DEPT. HEAD") > 0 Then
                        Me.Panel3.Enabled = True
                    Else
                        Me.Panel3.Enabled = False
                    End If
            ...
            Else  'rubah dari hrga sect ke hrga head '.. gak sido...
                If InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Then
                    Me.Panel2.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Then
                    Me.Panel2.Enabled = True
                Else
                    Me.Panel2.Enabled = False
                    Me.btnSetujuHrga.Visible = False
        ...
        ElseIf (dr.Item("Golongan").ToString) >= 19 Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                ...
                If dr.Item("ProjectManager").ToString <> "" Then
                    ...
                    'Proses Personnel---->>
                Else
                    If InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Then
                        Me.Panel3.Enabled = True
                    ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Then
                        Me.Panel3.Enabled = True
                    Else
                        Me.Panel3.Enabled = False
                    End If
    ...
    Protected Sub btnSetujuPM_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSetujuPM.Click
        ...
        With cmd
            ...
            If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                ...
                Dim cstext1 As String = "alert('Surat tugas telah tersimpan...    ');"
                cstext1 += "location='lstDinas.aspx?n=" & Me.lblNomor.Text & "'"
                cs.RegisterStartupScript(cstype, csname1, cstext1, True)
