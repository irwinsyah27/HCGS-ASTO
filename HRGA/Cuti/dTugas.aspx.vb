    ...
    Sub CariSC()
        ...
        If (dr.Item("Golongan").ToString) <= 18 Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                ...
                Else 'rubah dari hrga head ke pm'..gak sido...
                    ...
                    If InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0 Then
                    ...
                    ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PROJECT MANAGER") > 0 Then
                        Me.Panel3.Enabled = True
                    Else
                        Me.Panel3.Enabled = False
                    End If
                    'If InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Then
                    '    Me.Panel3.Enabled = True
            ...
            Else  'rubah dari hrga sect ke hrga head '...gaksido..
                ...
                If InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Then
                    ...
                    'ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS DEPT. HEAD") > 0 Then
                ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "PAYROLL SITE OFFICER") > 0 Then
                    Me.Panel2.Enabled = True
                    'If InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 Then
                    '    Me.Panel2.Enabled = True
        ...
        ElseIf (dr.Item("Golongan").ToString) >= 19 Then
            ...
            If dr.Item("TglValidasi").ToString <> "" Then
                ...
                End If
            Else
                If InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Then
                    Me.Panel2.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS DEPT. HEAD") > 0 Then
                    Me.Panel2.Enabled = True
                Else
                    Me.Panel2.Enabled = False
                End If
    ...
    Protected Sub btnSetujuHrga_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSetujuHrga.Click
        ...
        With cmd
            ...
            If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                ...
                Dim cstext1 As String = "alert('Surat tugas telah tersimpan...    ');"
                cstext1 += "location='lstTugas.aspx?n=" & Me.lblNomor.Text & "'"
                cs.RegisterStartupScript(cstype, csname1, cstext1, True)
