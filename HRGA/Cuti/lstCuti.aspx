...
Where Keperluan Like '%CUTI%' AND (Departemen = @DEPT OR @DEPT='ALL DEPT') AND (tblSutu.Status=@Status or @Status='ALL')   AND (Company=@Company or @Company='ALL') AND
...
">
                ...
                <asp:SqlDataSource ID="SqlStatus" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
                    SelectCommand="SELECT * FROM(SELECT DISTINCT [Status] FROM [tblSutu] where NomorST like '%SC' UNION SELECT 'ALL' AS [Status]) AS TBL Where Status <>''">
                </asp:SqlDataSource>
        ...
        <tr>
            <td style="width: 100%" valign="top">
                <asp:GridView ID="ViewKPP" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    Font-Overline="False" Font-Size="10pt" ForeColor="#333333" GridLines="None" PageSize="16"
                    Width="100%">
