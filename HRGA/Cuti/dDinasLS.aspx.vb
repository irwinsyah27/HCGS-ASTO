...
Partial Class HRGA_Cuti_dDinasLS
    ...
    Sub CariSC()
        ...
        With cmd
            ...
            .CommandText = "SELECT     tblSutu.NomorST, tblSutu.Nrp, vw_tblKaryawan.Nama, tblSutu.tglST, tblSutu.Tujuan, tblSutu.Keperluan, tblSutu.Penginapan, tblSutu.Hari, tblSutu.Awal, " _
                        ...
                        & "tblSutu.HR_Officer, tblSutu.HRGA_Head, tblSutu.TglValidasi, tblSutu.PersetujuanHrga,tblSutu.CatatanHrga, tblSutu.ProjectManager, tblSutu.TglPersetujuanPM, tblSutu.CatatanPM, tblSutu.DibuatOleh, " _
        ...
        If dr.Item("TglValidasi").ToString <> "" Then
            ...
            If dr.Item("ProjectManager").ToString <> "" Then
                ...
                'Proses Personnel---->>
            Else
                If InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Then
                    Me.Panel3.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Then
                    Me.Panel3.Enabled = True
                Else
                    Me.Panel3.Enabled = False
                End If
            End If
        Else
            If InStr(1, Session("jabatan").ToString, "HCGS SECT. HEAD") > 0 or InStr(1, Session("jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Then
                Me.Panel2.Enabled = True
            ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 or InStr(1, Session("ndPosisi").ToString, "PAYROLL SITE OFFICER") > 0 Then
                Me.Panel2.Enabled = True
            Else
                Me.Panel2.Enabled = False
                Me.btnSetujuHrga.Visible = False
    ...
    Protected Sub btnSetujuHrga_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSetujuHrga.Click
        ...
        With cmd
            ...
            If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                ...
                cstext1 += "location='dDinasLS.aspx?n=" & Me.lblNomor.Text & "'"
                cs.RegisterStartupScript(cstype, csname1, cstext1, True)
