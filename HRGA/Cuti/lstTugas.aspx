<%@ Page Language="VB" debug="true"MasterPageFile="../MasterHrga.master" AutoEventWireup="false" CodeFile="lstTugas.aspx.vb" Inherits="lstTugas" title="List Surat Tugas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="width: 100%; text-align: center">
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="14pt" Text="Karyawan Tugas"></asp:Label><br />
                &nbsp; 
    ...
    </asp:DropDownList><asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Status : "></asp:Label><asp:DropDownList
        ID="DDLStatus" runat="server" AutoPostBack="True" DataSourceID="SqlStatus"
        DataTextField="Status" DataValueField="Status">
    </asp:DropDownList>&nbsp;<asp:Label ID="Label6" runat="server" Font-Bold="True" Text="NRP : "></asp:Label><asp:TextBox ID="txNRP" runat="server"></asp:TextBox>&nbsp;<br />
    ...
    <asp:SqlDataSource ID="SqlStatus" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT * FROM(SELECT DISTINCT [Status] FROM [tblSutu] where NomorST like '%ST' UNION SELECT 'ALL' AS [Status]) AS TBL Where Status <>''">
    </asp:SqlDataSource>
...
Where Keperluan Like '%TUGAS%' AND (Departemen = @DEPT OR @DEPT='ALL DEPT') AND (tblSutu.Status=@Status or @Status='ALL')  AND (Company=@Company or @Company='ALL') AND
...
ORDER BY tblSutu.TglST DESC">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownList8" Name="Company" PropertyName="SelectedValue" />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        Width="100%" Font-Overline="False" Font-Size="10pt" PageSize="15" AllowPaging="True" AllowSorting="True">
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="NomorST" DataNavigateUrlFormatString="dTugas.aspx?n={0}"
                Text="Status" Target="_blank" DataTextField="Status" HeaderText="Status" SortExpression="Status" >
                <ItemStyle Width="80px" />
            </asp:HyperLinkField>
            <asp:TemplateField>
                <ItemTemplate>
