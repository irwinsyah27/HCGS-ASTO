<%@ Page Language="VB" Debug="TRUE"  AutoEventWireup="false" CodeFile="fTugasEmergency.aspx.vb" Inherits="_fTugasEmergency" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Surat Tugas Ketika Cuti</title>
        ...
        <table border="0" cellpadding="5" cellspacing="0" style="width: 100%; height: 100%" id="TABLE1" language="javascript" onclick="return TABLE1_onclick()">
            <tr>
                <td valign="top" align="center" style="width: 96%">
                    <asp:Label ID="Label21" runat="server" Font-Bold="True" Text="SURAT TUGAS KETIKA CUTI"></asp:Label><br />
                                            <asp:Label ID="lblNomor" runat="server" Font-Bold="True" ForeColor="Blue"></asp:Label></td>
            </tr>
            <tr>
                <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; width: 96%;" valign="top">
		            ...
		            href="javascript:;"><IMG src="Images/GoLtrHS.png" border="0" id="IMG3" runat="server" align="absMiddle" height="16" width="16"></A>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" valign="top">
                                            <asp:Label ID="Label19" runat="server" Text="No. Telp / Hp" Width="104px"></asp:Label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" rowspan="4" valign="top">
                                            <asp:Label ID="Label17" runat="server" Text="Alamat" Width="104px"></asp:Label></td>
                                        ...
                                        <td style="width: 100px;" rowspan="4" valign="top">
                                            <asp:Label ID="lblAlamatdiSite" runat="server" Font-Size="10pt" Width="173px"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 161px; height: 19px;">
                            ...
                            <tr>
                                <td align="left" colspan="5" style="height: 19px" valign="top">
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
                                        ...
                                        DataSourceID="SqlDataSource1" Font-Size="9pt" ForeColor="Black" GridLines="Horizontal"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Nama" SortExpression="Nama">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Nama") %>' Width="147px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Umur" SortExpression="Umur">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Umur") %>' Width="37px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("Umur") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Tanggal" SortExpression="Tanggal">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Tanggal") %>' Width="129px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("Tanggal") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Dari_Ke" SortExpression="Dari_Ke">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Dari_Ke") %>' Width="87px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("Dari_Ke") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
