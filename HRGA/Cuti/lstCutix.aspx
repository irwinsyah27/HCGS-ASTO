<%@ Page Language="VB" debug="true "MasterPageFile="../MasterHrga.master" AutoEventWireup="false" CodeFile="lstCutix.aspx.vb" Inherits="lstCuti" title="List Surat Cuti" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="width: 102%; text-align: center">
    ...
    </asp:DropDownList><asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Company :" Visible="False"></asp:Label><asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDatacompany"
        DataTextField="company" DataValueField="company" Visible="False">
    </asp:DropDownList><asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Company :" Visible="False"></asp:Label><asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource3"
        DataTextField="departemen" DataValueField="departemen" Visible="False">
    </asp:DropDownList>
                <asp:Label ID="status" runat="server" Font-Bold="True" Text="Status :"></asp:Label>
                <asp:DropDownList ID="ddlstatus" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource5"
                    DataTextField="Status" DataValueField="Status">
                </asp:DropDownList><asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="Expression: persisConnectionString"
                    SelectCommand="SELECT DISTINCT Status FROM vw_SUTU UNION SELECT '' AS Status"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
        SelectCommand="SELECT vw_sutu.NomorST&#13;&#10;&#9;, vw_sutu.Nama&#13;&#10;&#9;, vw_sutu.Nrp&#13;&#10;&#9;, vw_sutu.Jabatan&#13;&#10;&#9;, vw_sutu.Departemen&#13;&#10;&#9;, vw_sutu.Tujuan&#13;&#10;&#9;, vw_sutu.Awal &#13;&#10;&#9;, vw_sutu.Akhir &#13;&#10;&#9;, vw_sutu.Keperluan&#13;&#10;&#9;, vw_sutu.Status &#13;&#10;FROM vw_sutu &#13;&#10;WHERE (vw_sutu.Keperluan LIKE '%CUTI%') AND (vw_sutu.Departemen = @DEPT)  &#13;&#10;and (vw_sutu.Status)= (@status) ORDER BY vw_sutu.tglST DESC&#13;&#10;">
        <SelectParameters>
