<%@ Page Language="VB" Debug="TRUE"  AutoEventWireup="false" CodeFile="dDinas.aspx.vb" Inherits="_dDinas" %>
                ...
                <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; width: 98%;" valign="top">
                            ...
                            <td>
                                <table border="0" cellpadding="0" cellspacing="1" style="width: 100%">
                                    <tr>
                                        ...
                                        <td align="right">
                                            <asp:Label ID="Label11" runat="server" Text="Periode Tugas" Width="91px"></asp:Label></td>
                            ...
                            <td colspan="2" valign="top" style="height: 117px">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" style="height: 19px">
                                            <asp:TextBox ID="txtHari" runat="server" Width="136px" Enabled="False"></asp:TextBox></td>
                                        <td colspan="2" style="height: 19px">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2" style="height: 19px">
                                            <asp:TextBox ID="txtPenginapan" runat="server" Enabled="False" Width="136px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30px; height: 19px">
                    ...
                    <asp:Panel ID="Panel3" runat="server" Height="100px" Visible="False" Width="100%">
                        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #3366cc 1px solid;
                            ...
                            <tr>
                                <td style="width: 37%; height: 19px; text-align: right">
                                    <asp:Label ID="lblHrOrPm" runat="server" Text="Hrpga Dept. Head /PM :"></asp:Label></td>
                                <td style="width: 100%; height: 19px">
