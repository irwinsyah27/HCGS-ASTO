...
Partial Class _fTugasEmergency
    ...
    Protected Sub btSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btSave.Click
        ...
        With cmd
			...
			.Parameters.Add("@HrgaHead",SqlDbType.VarChar, 100 )
			.Parameters.Add("@CatatanHrga",SqlDbType.VarChar, 100)
			.Parameters.Add("@ProjectManager",SqlDbType.VarChar, 100)
			.Parameters.Add("@CatatanPM",SqlDbType.VarChar, 100)
            .Parameters.Add("@DibuatOleh", SqlDbType.VarChar, 20)
			...
			.Parameters("@HrgaHead").Value = "SYSTEM"
			.Parameters("@CatatanHrga").Value = "OK"
			.Parameters("@ProjectManager").Value = "SYSTEM"
			.Parameters("@CatatanPM").Value = "OK"
            .Parameters("@DibuatOleh").Value = "SYSTEM"
