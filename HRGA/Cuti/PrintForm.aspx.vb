        ...
        If dr.Read = True Then
                ...
                If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                    ...
                    If dr.Item("PersetujuanAtasan").ToString <> "" Then
                        ...
                        End If
                    End If
                    If dr.Item("Status").ToString = "HCGS SECT. HEAD" OR dr.Item("Status").ToString = "HCGS Dept" Then
                        cstext1 = "alert('  Form "& dr.Item("Keperluan").ToString &" diproses HCGS...    ');self.close()"
                        GoTo x
                    End If
                    If (dr.Item("Status").ToString = "HCGS & FAT DEPT. HEAD" OR dr.Item("Status").ToString = "PM")  AND dr.Item("NC").ToString <> "LS" Then
                        cstext1 = "alert('  Form "& dr.Item("Keperluan").ToString &" diproses PM / HCGS...    ');self.close()"
                        GoTo x
                    END If
