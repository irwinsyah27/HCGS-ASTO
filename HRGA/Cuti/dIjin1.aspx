<%@ Page Language="VB" Debug="TRUE" MasterPageFile="../MasterHrga.master" AutoEventWireup="false" CodeFile="dIjin1.aspx.vb" Inherits="HRGA_dIjin1" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="3" cellspacing="0">
        <tr>
            ...
            <td style="width: 700px" valign="top">
                <br />
                <asp:Panel ID="Panel2" runat="server" Height="300px" Width="125px">
        <fieldset id="Panel1" style="margin-left: 5px; width: 664px; margin-right: 5px; text-align: left">
            ...
            <table border="0" cellpadding="2" cellspacing="0" style="width: 100%">
                ...
                <tr>
                    <td style="width: 154px">
                        <asp:Label ID="Label16" runat="server" Text="Dibuat Oleh" Font-Bold="True"></asp:Label></td>
                    <td style="width: 100px">
                        &nbsp;<asp:Label ID="lblRequestor" runat="server" BorderStyle="Solid" BorderWidth="1px" Font-Bold="False" Width="488px"></asp:Label></td>
                </tr>
                <tr>
                    <td style="width: 154px">
                        <asp:Label ID="Label17" runat="server" Text="Tanggal Dibuat" Font-Bold="True"></asp:Label></td>
                    <td style="width: 100px">
                        &nbsp;<asp:Label ID="lblTglCreated" runat="server" BorderStyle="Solid" BorderWidth="1px" Font-Bold="False" Width="488px"></asp:Label></td>
                </tr>
                <tr>
            ...
            <br />
                ...
                <br />
    <asp:Panel ID="Panel3" runat="server" Height="200px" Width="125px" Enabled="False">
    <fieldset style="margin-left: 5px; width: 664px; margin-right: 5px;">
    ...
    <asp:Panel ID="Panel4" runat="server" Height="200px" Width="125px" Visible="False" Enabled="False">
    <fieldset style="margin-left: 5px; width: 664px; margin-right: 5px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 70%">
                    &nbsp;<asp:RadioButton ID="RadioValidasi1" runat="server" Text="Sesuai PP" GroupName="status" AutoPostBack="True" /><asp:RadioButton ID="RadioValidasi2" runat="server" Text="Tidak Sesuai PP" GroupName="status" AutoPostBack="True" /></td>
            </tr>
            <tr>
