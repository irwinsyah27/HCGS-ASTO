...
Partial Class HRGA_Cuti_PrintFormD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If UCase(Right(y, 2)) = "SC" Then
            ReportViewer1.ServerReport.ReportPath = "/HRGA/Form_Deklarasi_Perjalanan_Dinas"
        End If
    ...
    Sub CariSC()
        ...
        With cmd
            ...
            .CommandText = "SELECT     tblSutu.NOMORST, tblSutu.Nrp, vw_tblKaryawan.Nama, vw_tblKaryawan.StatusPenerimaan,tblSutu.tglST, tblSutu.Tujuan, tblSutu.Keperluan, tblSutu.Penginapan, tblSutu.Hari, tblSutu.Awal, " _
            ...
            If dr.Item("ProjectManager").ToString = "" Then
                ...
                If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                    ...
                    If dr.Item("HRGA_Head").ToString = "" Then
                        cstext1 = "alert('  Form cuti diproses hrga...    ');self.close()"
                        GoTo x
                    End If
                    If dr.Item("ProjectManager").ToString = "" Then
                        cstext1 = "alert('  Form cuti diproses PM / HRGA...    ');self.close()"
                        GoTo x
                    Else
                        cstext1 = "alert('  Form cuti diproses Personalia...    ');self.close()"
                    End If
