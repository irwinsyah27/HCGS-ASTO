...
Partial Class _dCuti
    ...
    Sub AwalCutiTahunan()
        ...
        If Me.txtAwal.Text <> "" Then
            ...
            If Me.txtPerjalanan.Text <> "0" Then
                AwalCTahunan = AwalCTahunan.AddDays(CInt(Me.txtLapangan.Text))
            Else
    ...
    Sub CariSC()
        ...
        If dr.Item("PersetujuanAtasan").ToString <> "" Then
            ...
            If (dr.Item("Golongan").ToString) <= 18 Then
                ...
                If dr.Item("TglValidasi").ToString <> "" Then
                    ...
                    Me.lblHrSecOrHrDeptHead.Text = "Hrga Section Head/Dept. Head :"
                    Me.lblHrOrPm.Text = "Hrga Dept. Head/PM :"
                ...
                Else  'diganti dari hrga sect ke hrga head'.... kagak jadi....
                    ''If InStr(1, Session("jabatan").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRPGA Dept. Head") > 0 Then
                    If InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT Dept. Head") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "FAT Sect. Head") > 0 Or InStr(1, Session("jabatan").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("Jabatan").ToString, "SHE SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS SECT. HEAD") > 0 Or InStr(1, Session("Jabatan").ToString, "HRM & ENGINEERING SECT. HEAD") > 0 Or InStr(1, Session("Jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Then
                        Me.Panel2.Enabled = True
                        ''ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRPGA Dept. Head") > 0 Then
            ...
            ElseIf (dr.Item("Golongan").ToString) >= 19 Then
                ...
                Else
                    If InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HCGS & FAT Dept. Head") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "FAT Sect. Head") > 0 Or InStr(1, Session("jabatan").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("Jabatan").ToString, "SHE SECT. HEAD") > 0 Or InStr(1, Session("Jabatan").ToString, "HRM & ENGINEERING SECT. HEAD") > 0 Or InStr(1, Session("Jabatan").ToString, "PAYROLL SITE OFFICER") > 0 Or InStr(1, Session("jabatan").ToString, "SM SITE SECT. HEAD") > 0 Then
                        Me.Panel2.Enabled = True
                    ElseIf InStr(1, Session("ndPosisi").ToString, "HCGS & FAT DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HCGS & FAT Dept. Head") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SHE SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENGINEERING SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "SM SITE SECT. HEAD") > 0 Then
                        Me.Panel2.Enabled = True
                    Else
                        Me.Panel2.Enabled = False
                    End If
        ...
        Else
            Me.Panel4.Visible = False
            If InStr(1, Jabatan, "DEPT. HEAD") > 0 Or InStr(1, Jabatan, "Dept. Head") > 0 Or InStr(1, Jabatan, "SECT. HEAD") > 0 Or InStr(1, Jabatan, "Sect. Head") > 0 Then
                If InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0 Or InStr(1, Session("jabatan").ToString, "Project Manager") > 0 Or InStr(1, Session("jabatan").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "FAT Sect. Head") > 0 Or InStr(1, Session("jabatan").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("jabatan").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Then
                    Me.Panel1.Enabled = True
                ElseIf InStr(1, Session("ndPosisi").ToString, "PROJECT MANAGER") > 0 Or InStr(1, Session("ndPosisi").ToString, "Project Manager") > 0 Or InStr(1, Session("ndPosisi").ToString, "FAT SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "FAT Sect. Head") > 0 Or InStr(1, Session("ndPosisi").ToString, "SM SITE SECT. HEAD") > 0 Or InStr(1, Session("ndPosisi").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0 Then
                    Me.Panel1.Enabled = True
                Else
                    Me.Panel1.Enabled = False
                End If
            Else
            'Penambahan Approval HRMENG
                If (Trim(dr.Item("Departemen").ToString) = Trim(Session("dept").ToString)) Or (InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0) Or (InStr(1, Session("ndPosisi").ToString, "PROJECT MANAGER") > 0) Or (InStr(1, Session("jabatan").ToString, "Project Manager") > 0) Or (InStr(1, Session("ndPosisi").ToString, "Project Manager") > 0 Or (InStr(1, Session("jabatan").ToString, "HRM & ENGINEERING DEPT. HEAD") > 0) Or (InStr(1, Session("ndPosisi").ToString, "HRM & ENGINEERING DEPT. HEAD")) Or (InStr(1, Session("jabatan").ToString, "HCGS & FAT DEPT. HEAD")) Or (InStr(1, Session("jabatan").ToString, "FAT SECT. HEAD"))) Then
                    ...
                    ElseIf InStr(1, Session("ndPosisi").ToString, "Dept. Head") > 0 Then
                        Me.Panel1.Enabled = True
                    ElseIf InStr(1, Session("jabatan").ToString, "PROJECT MANAGER") > 0 Then
                        Me.Panel1.Enabled = True
                    ElseIf InStr(1, Session("jabatan").ToString, "Project Manager") > 0 Then
                        Me.Panel1.Enabled = True
                    ...
                    ElseIf InStr(1, Session("ndPosisi").ToString, "Sect. Head") > 0 Then
                        Me.Panel1.Enabled = True
                    ElseIf InStr(1, Session("jabatan").ToString, "GL") > 0 Then
                        Me.Panel1.Enabled = True
                    ElseIf InStr(1, Session("jabatan").ToString, "gl") > 0 Then
                        Me.Panel1.Enabled = True
                    Else
