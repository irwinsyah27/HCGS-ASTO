...
Partial Class trainsite
    ...
    Protected Sub btnsend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsend.Click
        ...
        End If
        If Len(nomer) = 1 Then
            nomer = "ADRO/HRP/" & th2 & "/000" & nomer & "/TRS"
        ElseIf Len(nomer) = 2 Then
            nomer = "ADRO/HRP/" & th2 & "/00" & nomer & "/TRS"
        ElseIf Len(nomer) = 3 Then
            nomer = "ADRO/HRP/" & th2 & "/0" & nomer & "/TRS"
        End If
        con.Close()
        ''=====
        'MsgBox(nomer)
        ...
        With cmd2
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "Insert Into tbl_trains (Notrs,NRPcreator,TglCreated,uraiantraining,lokasitraining) Values(@NotRS,@NrpUser,getdate(),@uraiantraining,@lokasi)"
