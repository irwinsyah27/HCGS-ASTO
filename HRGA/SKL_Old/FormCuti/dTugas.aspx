                            ...
                            <td colspan="2" valign="top" style="height: 117px">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="height: 19px">
                                            <asp:TextBox ID="txtTransport" runat="server" Enabled="False" Width="136px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30px; height: 19px">
                                            <asp:Label ID="Label14" runat="server" Text="Uang Muka" Width="104px"></asp:Label></td>
                                        <td colspan="2" style="height: 19px">
                                            <asp:TextBox ID="txtUangMuka" runat="server" Enabled="False" Width="136px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30px; height: 19px">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #3366cc 1px solid;
                            ...
                            <tr>
                                ...
                                <td style="width: 100%; height: 19px">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCatatan"
