<%@ Page Language="VB" debug="true"AutoEventWireup="false" CodeFile="vwskl.aspx.vb" Inherits="vwskl" %>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td style="width: 5%; height: 21px">
                                                        <asp:Image ID="Image1" runat="server" Height="56px" ImageUrl="images/Logo.jpg" Width="56px" /></td>
                                    ...
                                    <tr>
                                        <td colspan="3" style="border-right: black 2px solid; border-top: black 2px solid;
                                            ...
                                            border-bottom: silver 1px dashed; font-family: 'Berlin Sans FB'; height: 29px;
                                            background-color: silver; text-decoration: underline">
                                            ATASAN
                                        </td>
                                    ...
                                    <tr>
                                        <td style="border-bottom-width: 2px; border-bottom-color: black; border-left: black 2px solid;
                                            width: 20%; height: 19px; border-right-width: 1px; border-right-color: maroon">
                                            <asp:Label ID="lblCatatan" runat="server" Height="100%" Style="border-bottom: maroon 1px solid;
                                                background-color: floralwhite" Text="Catatan" Width="99.5%"></asp:Label></td>
                                        ...
                                        <td style="border-bottom-width: 2px; border-bottom-color: black; width: 70%; height: 19px;
                                    ...
                                    <tr>
                                        <td colspan="3" style="border-top-width: 2px; font-weight: bold; border-left-width: 2px;
                                            ...
                                            height: 5px; border-right-width: 2px; text-decoration: underline; border-right-color: black">
