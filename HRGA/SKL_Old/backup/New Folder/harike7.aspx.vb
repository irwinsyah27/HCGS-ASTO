...
Partial Class HRGA_SKL_SKaEl_Ha
    ...
    Protected Sub btnsend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsend.Click
        ...
        '================== Nomor Terakhir NEW 5 DIGIT====================
        con.Open()
        With cmd1
            .Connection = con
            .CommandType = CommandType.Text
            '.CommandText = "Select Top 1 NoSKL From tbl_SKL1 where skl='H7'Order By NoSKL Desc"
            .CommandText = "Select Top 1 NoSKL From tbl_SKL1 where NOSKL LIKE '%SK7%' Order By TglCreated DESC, NoSKL DESC"
        ...
        '    End If
        '    If Len(nomer) = 1 Then
        '        nomer = "ADRO/HRP/" & th2 & "/0000" & nomer & "/SK7"
        '    ElseIf Len(nomer) = 2 Then
        '        nomer = "ADRO/HRP/" & th2 & "/000" & nomer & "/SK7"
        '    ElseIf Len(nomer) = 3 Then
        '        nomer = "ADRO/HRP/" & th2 & "/00" & nomer & "/SK7"
        '    ElseIf Len(nomer) = 4 Then
        '        nomer = "ADRO/HRP/" & th2 & "/0" & nomer & "/SK7"
        '    ElseIf Len(nomer) = 5 Then
        '        nomer = "ADRO/HRP/" & th2 & "/" & nomer & "/SK7"
        '    End If
        'End If
        If Len(nomer) = 1 Then
            nomer = "ADRO/HRP/" & th2 & "/0000" & nomer & "/SK7"
        ...
        End If
        con.Close()
        ''===== END OFF NEW NOMOR TERAKHIR 5 DIGIT===========
        ''================== Nomor Terakhir====================
        'con.Open()
        'With cmd1
        '    .Connection = con
        ...
        With cmd2
            ...
            .Parameters.Add("@No", SqlDbType.VarChar, 21)
            .Parameters.Add("@Nrp", SqlDbType.VarChar, 10)
