...
Partial Class HRGA_SKL_SKaEl_Ha
    ...
    Protected Sub btnsend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsend.Click
        ...
        End If
        If Len(nomer) = 1 Then
            nomer = "ADRO/HRP/" & th2 & "/000" & nomer & "/SKH"
        ElseIf Len(nomer) = 2 Then
            nomer = "ADRO/HRP/" & th2 & "/00" & nomer & "/SKH"
        ElseIf Len(nomer) = 3 Then
            nomer = "ADRO/HRP/" & th2 & "/0" & nomer & "/SKH"
        ElseIf Len(nomer) = 4 Then
            nomer = "ADRO/HRP/" & th2 & "/" & nomer & "/SKH"
        End If
        con.Close()
        ''=====
        ...
        With cmd2
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "Insert Into tbl_skl1 (NoSKL,NRPrequestor,TglCreated,uraianLembur,skl) Values(@NoSKL,@NrpUser,getdate(),@uraianlembur,@skl)"
