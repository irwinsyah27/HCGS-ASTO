...
Partial Class skl
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        With cmd
            .Connection = con
            .CommandType = CommandType.Text
            .CommandText = "Select Nrp, Nama, Jabatan, Golongan, Departemen, StatusPenerimaan, StatusKawin, StatusBawaKeluarga, AlamatTinggal, Telepon,onsite  From vw_tblkaryawan Where Nrp = @Nrp "
        ...
        If dr.Read = True Then
            ...
            ''Me.listnrp.Items.Remove(Me.listnrp.SelectedIndex.ToString)

            ''Me.listnama.Items.Remove(Me.listnrp.SelectedIndex.ToString)


            'AND (LEFT (Golongan, 1) <> '4') AND (LEFT (Golongan, 1) <> '5') AND (onsite = '1') OR (Dept = @Dept) AND (Golongan IS NULL) AND (onsite = '1')
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnremove.Click
    ...
    Protected Sub listnrp_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles listnrp.SelectedIndexChanged
        ...
        'pilih = Me.listnrp.SelectedItem.ToString
        ...
        'Me.listnrp.Items.Remove(pilih)

        'Me.listnama.Items.Remove(pilih)
    End Sub

    Protected Sub listnama_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles listnama.SelectedIndexChanged
        'Me.listnrp.Items.Remove(Me.listnrp.SelectedItem.Text.ToString)

        'Me.listnama.Items.Remove(Me.listnama.SelectedItem.ToString)
    End Sub
