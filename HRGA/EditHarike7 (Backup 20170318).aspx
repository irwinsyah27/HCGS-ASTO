...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
            DeleteCommand="DELETE FROM [tblKaryawan] WHERE [Nrp] = @Nrp" InsertCommand="INSERT INTO [tblKaryawan] ([Nrp], [Nama], [Departemen], [Harike7]) VALUES (@Nrp, @Nama, @Departemen, @Harike7)"
            SelectCommand="SELECT A.Nrp, A.Nama, A.Departemen, RTrim(A.Harike7) As Harike7, B.TanggalHarike7 FROM tblKaryawan A INNER JOIN vw_Harike7 B ON A.Nrp= B.Nrp Where ((A.Nrp Like '%' + @Nrpp + '%' AND A.Departemen = @Dept ) )&#13;&#10;&#13;&#10;"
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="txtSearch" Name="Nrpp" PropertyName="Text" />
