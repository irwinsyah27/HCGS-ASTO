...
Partial Class _HRGA_EditIO2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If InStr(1, Session("Jabatan").ToString, "KORLAP") = 0 And InStr(1, Session("Jabatan").ToString, "KORLAP TEGAP") = 0 And InStr(1, Session("Jabatan").ToString, "Korlap Solid") = 0 And InStr(1, Session("Jabatan").ToString, "Korlap ERM") = 0 Then
            ...
            If (Not cs.IsStartupScriptRegistered(cstype, csname1)) Then
                ...
                Dim cstext1 As String = "alert('Anda tidak punya access sebagai  korlap...    ');"
