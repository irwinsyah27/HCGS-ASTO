<%@ Page Language="VB" MasterPageFile="~/HRGA/Trans/MasterTrans2.master" AutoEventWireup="false" CodeFile="Transaksi1.aspx.vb" Inherits="HRGA_Trans_Transaksi1" title="Untitled Page" %>
                        ...
                        <asp:TemplateField HeaderText="Kode" SortExpression="Kode">
                            <EditItemTemplate>
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataKode" DataTextField="Keterangan"
                                    ...
                                    SelectCommand="SELECT [Kode],[Keterangan] FROM [tblKodeTransaksi] Where [Kode] Not In ('B','G','H','M','T','U') UNION SELECT '' As [Kode],'' As [Keterangan] From [tblKodeTransaksi] &#13;&#10;">
                                </asp:SqlDataSource>
                            </EditItemTemplate>
                            <ItemTemplate>
