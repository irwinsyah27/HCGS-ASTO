<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Copy of Transaksi.aspx.vb" Inherits="HRGA_Trans_Transaksi" %>
            ...
            <tr>
                <td align="center" style="width: 101px; height: 27px" valign="top">
                    <br />
                        ...
                        <asp:Label ID="Label6" runat="server" Text="Transaksi" Width="510px" BackColor="#FFFF80" Font-Bold="True" Font-Size="24pt"></asp:Label></td>
            </tr>
            <tr>
