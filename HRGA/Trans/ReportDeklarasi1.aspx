<%@ Page Language="VB" MasterPageFile="~/HRGA/Trans/MasterTrans.master" AutoEventWireup="false" CodeFile="ReportDeklarasi1.aspx.vb" Inherits="HRGA_Trans_ReportDeklarasi1" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" BorderColor="Black" BorderStyle="Solid"
        ...
        <LocalReport ReportPath="HRGA\Trans\ReportDeklarasi1.rdlc">
            <DataSources>
