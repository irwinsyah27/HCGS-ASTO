<%@ Page Language="VB" MasterPageFile="~/HRGA/Trans/MasterTrans2.master" AutoEventWireup="false" CodeFile="Transaksi2.aspx.vb" Inherits="HRGA_Trans_Transaksi2" title="Untitled Page" %>
        ...
        <tr>
            <td style="width: 803px">
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#CCCCFF"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="Nilai" SortExpression="Nilai">
                            <EditItemTemplate>
                                <asp:TextBox Enabled="False" ID="TextBox4" runat="server" Text='<%# Bind("Nilai") %>' Width="70px"></asp:TextBox>
                            </EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Kode" SortExpression="Kode">
                            <EditItemTemplate>
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataKode" DataTextField="Keterangan"
                                    ...
                                    SelectCommand="SELECT [Kode],[Keterangan] FROM [tblKodeTransaksi] Where [Kode] In ('B','T') UNION SELECT '' As [Kode],'' As [Keterangan] From [tblKodeTransaksi] &#13;&#10;">
                                </asp:SqlDataSource>
                            </EditItemTemplate>
                            <ItemTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
                    DeleteCommand="DELETE FROM [tblTransaksi] WHERE [ID] = @ID" 
                    InsertCommand="INSERT INTO [tblTransaksi] ([Tgl],[Lokasi],[Hotel],[UPD],[Lainlain] [Nilai], [Keterangan], [Nrp]) VALUES (@Tgl,@Lokasi,@Hotel,@UPD,@Lainlain, @Nilai, @Keterangan, @Nrp)"
