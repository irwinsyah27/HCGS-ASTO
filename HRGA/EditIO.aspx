<%@ Page Language="VB" MasterPageFile="MasterHrga.master" AutoEventWireup="false" CodeFile="EditIO.aspx.vb" Inherits="_HRGA_EditIO" title="Edit" %>
    ...
    <asp:Label ID="User" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="IN" SortExpression="in">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("in") %>' Width="37px"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("in") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="OUT" SortExpression="out">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("out") %>' Width="37px"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("out") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="SKL" SortExpression="SKL">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("SKL") %>' Width="60px"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("SKL") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="SKL1" SortExpression="SKL1">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("SKL1") %>' Width="60px"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label6" runat="server" Text='<%# Bind("SKL1") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Ket Absen" SortExpression="ket_absen">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList4" runat="server" SelectedValue='<%# Bind("ket_absen") %>'>
                            <asp:ListItem Selected="True"></asp:ListItem>
                            <asp:ListItem>IN KOSONG</asp:ListItem>
                            <asp:ListItem>OUT KOSONG</asp:ListItem>
                            <asp:ListItem>IN & OUT KOSONG</asp:ListItem>
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label9" runat="server" Text='<%# Bind("ket_absen") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Tgl Terima BA" SortExpression="tgl_ba">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("tgl_ba") %>' Width="80px"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label10" runat="server" Text='<%# Bind("tgl_ba") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Data_abs1ConnectionString %>"
            ...
            InsertCommand="INSERT INTO [lembarkerja] ([nrp], [tanggal], [in], [out],[ket_absen],[tgl_ba],[keterangan]) VALUES (@nrp, @tanggal, @in, @out, @ket_absen, @tgl_ba,@keterangan)"
            ...
            UpdateCommand="UPDATE [lembarkerja] SET  [shift] = @shift, [in] = @in, [out] = @out, [absent] = @absent,  [skl] = @skl,  [skl1] = @skl1, [ket_absen]=@ket_absen,[tgl_ba]=@tgl_ba,[keterangan]=@keterangan , [rostercode]=@rostercode, [UserUpdate]=@UserUpdate  WHERE [id] = @id">
            <DeleteParameters>
