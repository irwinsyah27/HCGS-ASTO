    ...
    <fieldset style="width: 334px"><legend>Edit Karyawan </legend>
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4"
            ...
            <Fields>
                ...
                <asp:TemplateField HeaderText="POH" SortExpression="POH">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList9" runat="server" SelectedValue='<%# Bind("POH") %>'>
                            <asp:ListItem> </asp:ListItem>
                            <asp:ListItem Selected="True">JAKARTA</asp:ListItem>
                            <asp:ListItem>BANJAR</asp:ListItem>
                            <asp:ListItem>TAPIN</asp:ListItem>
                            <asp:ListItem>TANAH LAUT</asp:ListItem>
                            <asp:ListItem>BANJARMASIN</asp:ListItem>
                            <asp:ListItem>TANAH BUMBU</asp:ListItem>
                            <asp:ListItem>TARAKAN</asp:ListItem>
                            <asp:ListItem>MALINAU</asp:ListItem>
                            <asp:ListItem>LOREH</asp:ListItem>
                            <asp:ListItem>KUTAI TIMUR</asp:ListItem>
                            <asp:ListItem>BALIKPAPAN</asp:ListItem>
                            <asp:ListItem>SAMARINDA</asp:ListItem>
                            <asp:ListItem>BARITO TIMUR</asp:ListItem>
                            <asp:ListItem>BUHUT</asp:ListItem>
                            <asp:ListItem>MUARA BAKAH</asp:ListItem>
                            <asp:ListItem>PALANGKARAYA</asp:ListItem>
                            <asp:ListItem>MUARA TEWEH</asp:ListItem>
                            <asp:ListItem>MUARA ENIM</asp:ListItem>
                            <asp:ListItem>LAHAT</asp:ListItem>
                            <asp:ListItem>SUMBAWA</asp:ListItem>
                            <asp:ListItem>PALEMBANG</asp:ListItem>
                            <asp:ListItem>KONAWE UTARA</asp:ListItem>
                            <asp:ListItem>KENDARI</asp:ListItem>
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <InsertItemTemplate>
                        <asp:DropDownList ID="DropDownList9" runat="server" SelectedValue='<%# Bind("POH") %>'>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label12" runat="server" Text='<%# Bind("POH") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Harike7" SortExpression="Harike7">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList70" runat="server" SelectedValue='<%# Bind("Harike7") %>'>
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem Selected="True">Minggu</asp:ListItem>
                    ...
                    <InsertItemTemplate>
                        &nbsp;<asp:DropDownList ID="DropDownList71" runat="server" SelectedValue='<%# Bind("Harike7") %>'>
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem Selected="True">Minggu</asp:ListItem>
                            <asp:ListItem>Senin</asp:ListItem>
                            <asp:ListItem>Selasa</asp:ListItem>
                ...
                <asp:TemplateField HeaderText="Company" SortExpression="Company">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList66" runat="server" SelectedValue='<%# Bind("Company") %>'>
                            ...
                            <asp:ListItem>JBI</asp:ListItem>
                            <asp:ListItem>NBID</asp:ListItem>
                            <asp:ListItem>KMB</asp:ListItem>
                            <asp:ListItem>TRT</asp:ListItem>
                            <asp:ListItem>IMA</asp:ListItem>
                            <asp:ListItem>NWK</asp:ListItem>
                ...
                <asp:TemplateField HeaderText="Lokasi Kerja" SortExpression="Lokasi_kerja">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList68" runat="server" SelectedValue='<%# Bind("Lokasi_Kerja") %>'>
                            ...
                            <asp:ListItem>PITSTOP KM 40</asp:ListItem>
                            <asp:ListItem>CS KM 43</asp:ListItem>
							<asp:ListItem>CRUSHER</asp:ListItem>
							<asp:ListItem>KM25 WORKSHOP</asp:ListItem>
                            <asp:ListItem>EMBUNG</asp:ListItem>
                            <asp:ListItem>CAMP OFFICE</asp:ListItem>
							<asp:ListItem>MESS ANGGREK</asp:ListItem>
							<asp:ListItem>CS KM 64</asp:ListItem>
                            <asp:ListItem>KM25 WAREHOUSE</asp:ListItem>
                ...
                <asp:TemplateField HeaderText="Lokasi_Cost" SortExpression="Lokasi_Cost">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList72" runat="server" SelectedValue='<%# Bind("Lokasi_Cost") %>'>
                            <asp:ListItem></asp:ListItem>	
							<asp:ListItem Selected="True">HSQ</asp:ListItem>
                            <asp:ListItem>ABB HAULING</asp:ListItem>
                            <asp:ListItem>ABB ROAD MAINTENANCE</asp:ListItem>
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <InsertItemTemplate>
                        &nbsp;<asp:DropDownList ID="DropDownList73" runat="server" SelectedValue='<%# Bind("Lokasi_Cost") %>'>
                            <asp:ListItem></asp:ListItem>
							<asp:ListItem Selected="True">HSQ</asp:ListItem>
                            <asp:ListItem>ABB HAULING</asp:ListItem>
                            <asp:ListItem>ABB ROAD MAINTENANCE</asp:ListItem>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label88" runat="server" Text='<%# Bind("Lokasi_Cost") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Mess" SortExpression="Mess">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList81" runat="server" SelectedValue='<%# Bind("Mess") %>'>
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem Selected="True">Integrity</asp:ListItem>
                            <asp:ListItem>Safety</asp:ListItem>
                            <asp:ListItem>Synergi</asp:ListItem>
                            <asp:ListItem>Funtastic</asp:ListItem>
							<asp:ListItem>Joyfull</asp:ListItem>
                            <asp:ListItem>Cheerfull</asp:ListItem>
                            <asp:ListItem>Happiness</asp:ListItem>
							<asp:ListItem>Greatfull</asp:ListItem>
							<asp:ListItem>Powerfull</asp:ListItem>
                            <asp:ListItem>Non Mess</asp:ListItem>
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <InsertItemTemplate>
                        <asp:DropDownList ID="DropDownList82" runat="server" SelectedValue='<%# Bind("Mess") %>'>
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem Selected="True">Integrity</asp:ListItem>
                            <asp:ListItem>Safety</asp:ListItem>
                            <asp:ListItem>Synergi</asp:ListItem>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Labe81" runat="server" Text='<%# Bind("Mess") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="NoKamar" HeaderText="NoKamar" SortExpression="NoKamar" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:persisConnectionString %>"
			...
			InsertCommand="INSERT INTO [tblKaryawan] ([Nrp], [Nama], [TempatLahir], [TglLahir], [JenisKelamin], [POH],[GolonganDarah], [StatusKawin], [DPA], [TglMasukPama], [TglPensiun], [Golongan], [Agama], [Pendidikan], [AlamatTinggal], [Jamsostek], [Jabatan], [TglMutasi], [StatusKeluarga], [StatusBawaKeluarga], [TglBawaKeluarga], [Departemen], [StatusPenerimaan], [Telepon], [Lokasi], [SisaCutiPeriode1], [SisaCutiPeriode2], [SisaCutiBesar], [OnSite], [Company], [Harike7],[Rekening],[MasaDinas],[Mess],[NoKamar],[Lokasi_Kerja],[Lokasi_Cost],[Gaji]) VALUES (@Nrp, @Nama, @TempatLahir, @TglLahir, @JenisKelamin, @POH,@GolonganDarah, @StatusKawin, @DPA, @TglMasukPama, @TglPensiun, @Golongan, @Agama, @Pendidikan, @AlamatTinggal, @Jamsostek, @Jabatan, @TglMutasi, @StatusKeluarga, @StatusBawaKeluarga, @TglBawaKeluarga, @Departemen, @StatusPenerimaan, @Telepon, @Lokasi, @SisaCutiPeriode1, @SisaCutiPeriode2, @SisaCutiBesar, @OnSite, @Company, @Harike7, @Rekening, @MasaDinas, @Mess, @NoKamar,@Lokasi_Kerja, @Lokasi_Cost, @Gaji)"
            SelectCommand="SELECT [Nrp], [Nama], [TempatLahir], [TglLahir], [JenisKelamin], [POH],[GolonganDarah], [StatusKawin], [DPA], [TglMasukPama], [TglPensiun], [Golongan], [Agama], [Pendidikan], [AlamatTinggal], [Jamsostek], [Jabatan], [TglMutasi], [StatusKeluarga], [StatusBawaKeluarga], [TglBawaKeluarga], [Departemen], [StatusPenerimaan], [Telepon], [Lokasi], [SisaCutiPeriode1], [SisaCutiPeriode2], [SisaCutiBesar], [OnSite], [Company], [Rekening],[Harike7],[MasaDinas],[Mess],[NoKamar],[Lokasi_Kerja],[Lokasi_Cost],[Gaji] FROM [tblKaryawan] WHERE ([Nrp] = @Nrp)"
            UpdateCommand="UPDATE [tblKaryawan] SET [Nama] = @Nama, [TempatLahir] = @TempatLahir, [TglLahir] = @TglLahir, [JenisKelamin] = @JenisKelamin, [POH] = @POH,[GolonganDarah] = @GolonganDarah, [StatusKawin] = @StatusKawin, [DPA] = @DPA, [TglMasukPama] = @TglMasukPama, [TglPensiun] = @TglPensiun, [Golongan] = @Golongan, [Agama] = @Agama, [Pendidikan] = @Pendidikan, [AlamatTinggal] = @AlamatTinggal, [Jamsostek] = @Jamsostek, [Jabatan] = @Jabatan, [TglMutasi] = @TglMutasi, [StatusKeluarga] = @StatusKeluarga, [StatusBawaKeluarga] = @StatusBawaKeluarga, [TglBawaKeluarga] = @TglBawaKeluarga, [Departemen] = @Departemen, [StatusPenerimaan] = @StatusPenerimaan, [Telepon] = @Telepon, [Lokasi] = @Lokasi, [SisaCutiPeriode1] = @SisaCutiPeriode1, [SisaCutiPeriode2] = @SisaCutiPeriode2, [SisaCutiBesar] = @SisaCutiBesar, [OnSite] = @OnSite, [Company] = @Company, [Harike7] = @Harike7,[Rekening] = @Rekening, [MasaDinas] = @MasaDinas, [Mess] = @Mess, [NoKamar] = @NoKamar,[Lokasi_Kerja] = @Lokasi_Kerja, [Lokasi_Cost] = @Lokasi_Cost, [Gaji] = @Gaji WHERE [Nrp] = @Nrp" ProviderName="<%$ ConnectionStrings:persisConnectionString.ProviderName %>">
            <DeleteParameters>
            ...
            <UpdateParameters>
                ...
                <asp:Parameter Name="POH" Type="String" />
                ...
                <asp:Parameter Name="NoKamar" Type="String" />
				<asp:Parameter Name="Lokasi_Kerja" Type="String" />
                <asp:Parameter Name="Lokasi_Cost" Type="String" />
