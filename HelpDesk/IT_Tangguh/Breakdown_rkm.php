...
$update="UPDATE tbl_Asset SET Remark='$tStatus' WHERE NoAsset='$tNoAsset'";
                              ...
                              <tr>
                                <td bgcolor="#DDDDDD"><table width="94%" border="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="14%" class="ui-widget-content"><input name="tNoAsset" type="text" class="ui-widget-content" id="tNoAsset" title="Insert (NoAsset)" size="25" value="<? echo $tNoAsset; ?>" /></td>
                                    ...
                                    <tr>
                                      <td><div align="right" class="ui-widget-content"><span class="ui-widget-header">
                                        <select name="tStatus" class="ui-state-active" id="tStatus">
                                          <option value="REPIRE">REPIRE</option>
