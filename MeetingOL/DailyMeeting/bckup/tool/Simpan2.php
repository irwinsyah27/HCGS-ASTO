...
$koneksi=open_connection();
   ...
   $destination_path = '../'.$_SESSION[Dept].'/lampiranData/B/';
   $result = 0;
...
$insert="UPDATE DailyMeeting SET MPP='$tTOTAL',Sakit='$tTOTAL2',Izin='$tTOTAL3',Alpha='$tTOTAL4',FileB='$namaFile' WHERE NoDM='$NoDM'";
