...
$NmSec=$d1[NamaSec];
if ((($NmSec==$_SESSION[NamaSec]) and ($d1[Status]=='Close')) or (($_SESSION[User]='KC08090') or ($_SESSION[User]='KB10035') or ($_SESSION[User]='KA06049') or ($_SESSION[User]='KC10047') or ($_SESSION[User]='6103041') and ($d1[Status]=='Close'))) {
