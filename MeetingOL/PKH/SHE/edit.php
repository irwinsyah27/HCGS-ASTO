...
$NmSec=$d1[NamaSec];
if (($NmSec==$_SESSION[NamaSec]) or (($_SESSION[User]=='6100077') or ($_SESSION[User]=='TA11001') or ($_SESSION[User]=='KB05002') or ($_SESSION[User]=='6195011') or ($_SESSION[User]=='KC07103') or ($NmSec=='PIC'))) {
    ...
    <td width="532"><table width="100%" border="0" bgcolor="#FFFFFF">
      <tr>
        <td><table width="100%" border="0" bgcolor="#00843B">
          <tr>
            <td><form <? echo ("action=simpanU.php?PKH=$d1[NoPKH]"); ?> method="post" enctype="multipart/form-data" name="form1" id="form1">
                  <table width="100%" border="0">
                    <tr>
                      <td class="style7"><div align="center">Form Edit PKH </div></td>
                    </tr>
                  </table>
                              ...
                              <tr>
                                <td><table width="100%" border="0" bgcolor="#00843B">
                                    ...
                                    <tr>
                                      ...
                                      <td class="style8">:
                                        <input name="mLampiran" type="file" /></td>
                                    </tr>
                                    <tr>
                                      <td class="style8">&nbsp;</td>
                                      <td class="style8">&nbsp;</td>
