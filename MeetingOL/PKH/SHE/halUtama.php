...
$sel1=mysql_query("Select Departemen.DeptHead from Departemen where Departemen.NoDept='7'")or die ("Terdapat kesalahan pada perintah SQL!");
}
                      ...
                      <tr>
                        ...
                        <td width="14%"><div align="right">
                            <select name="Jmenu" onChange="MM_jumpMenu(this,'Report','width=1000,height=590,scrollbars=yes')">
                              <option value="#"> </option>
                              <option value="../../ReportServer/PKH/SHE/Open_PerPerioderpt.php">PKH_Open</option>
                              <option value="../../ReportServer/PKH/SHE/Close_PerPerioderpt.php">PKH_CloseOff</option>
                              <option value="../../ReportServer/PKH/SHE/Diagram_Secctb.php">Chart_StatusLaporan</option>
                            </select>
                        </div></td>
                      </tr>
                  </table></td>
                  ...
                  <td><table width="100%" border="0" bgcolor="#333333">
                    <tr>
                      ...
                      <select name="mKepada" id="mKepada" lang="" onChange="this.form.submit()">
                        ...
                        <option value="SHE" <?php if (!(strcmp("SHE", $mKepada))) {echo "selected=\"selected\"";} ?>>SHE</option>
                      </select>
                      </span></span></td>
                      <td width="22%"><label>
                        <div align="right">
