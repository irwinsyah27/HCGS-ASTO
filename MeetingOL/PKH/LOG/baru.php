...
$NmSec=$Sec;
if (($NmSec==$_SESSION[NamaSec]) or (($_SESSION[User]=='6100077') or ($_SESSION[User]=='KB09032') or ($_SESSION[User]=='KC05046') or ($_SESSION[User]=='KC07103') or ($_SESSION[User]=='6195011'))) {
...
<select name="select" disabled="disabled">
  ...
  <option value="2">2</option>
                                    ...
                                    <tr>
                                      ...
                                      <td class="style8">:
                                        <input name="mLampiran" type="file" id="mLampiran" /></td>
                                    </tr>
